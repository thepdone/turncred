...
public final class LongSaturatedMathKt {
    ...
    public static final long m7407saturatingAddNuflL3o(long j, DurationUnit unit, long j2) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        long jM7324toLongimpl = Duration.m7324toLongimpl(j2, unit);
        if (((j - 1) | 1) == Long.MAX_VALUE) {
            return m7406checkInfiniteSumDefinedPjuGub4(j, j2, jM7324toLongimpl);
        }
        if ((1 | (jM7324toLongimpl - 1)) == Long.MAX_VALUE) {
            return m7408saturatingAddInHalvesNuflL3o(j, unit, j2);
        }
        long j3 = j + jM7324toLongimpl;
        return ((j ^ j3) & (jM7324toLongimpl ^ j3)) < 0 ? j < 0 ? Long.MIN_VALUE : Long.MAX_VALUE : j3;
    }

    /* renamed from: checkInfiniteSumDefined-PjuGub4, reason: not valid java name */
    private static final long m7406checkInfiniteSumDefinedPjuGub4(long j, long j2, long j3) {
        if (!Duration.m7310isInfiniteimpl(j2) || (j ^ j3) >= 0) {
            return j;
        }
    ...
    private static final long m7408saturatingAddInHalvesNuflL3o(long j, DurationUnit durationUnit, long j2) {
        long jM7281divUwyO8pc = Duration.m7281divUwyO8pc(j2, 2);
        long jM7324toLongimpl = Duration.m7324toLongimpl(jM7281divUwyO8pc, durationUnit);
        return (1 | (jM7324toLongimpl - 1)) == Long.MAX_VALUE ? jM7324toLongimpl : m7407saturatingAddNuflL3o(m7407saturatingAddNuflL3o(j, durationUnit, jM7281divUwyO8pc), durationUnit, Duration.m7313minusLRDsOJo(j2, jM7281divUwyO8pc));
    }

    private static final long infinityOfSign(long j) {
        return j < 0 ? Duration.INSTANCE.m7380getNEG_INFINITEUwyO8pc$kotlin_stdlib() : Duration.INSTANCE.m7379getINFINITEUwyO8pc();
    }

    public static final long saturatingDiff(long j, long j2, DurationUnit unit) {
        Intrinsics.checkNotNullParameter(unit, "unit");
        if ((1 | (j2 - 1)) == Long.MAX_VALUE) {
            return Duration.m7331unaryMinusUwyO8pc(infinityOfSign(j2));
        }
    ...
    private static final long saturatingFiniteDiff(long j, long j2, DurationUnit durationUnit) {
        ...
        if (((j3 ^ j) & (~(j3 ^ j2))) < 0) {
            if (durationUnit.compareTo(DurationUnit.MILLISECONDS) < 0) {
                ...
                return Duration.m7314plusLRDsOJo(DurationKt.toDuration(j4, DurationUnit.MILLISECONDS), DurationKt.toDuration(j5, durationUnit));
            }
            return Duration.m7331unaryMinusUwyO8pc(infinityOfSign(j3));
        }
