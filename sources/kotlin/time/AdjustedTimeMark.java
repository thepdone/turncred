...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo7269minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m7415minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo7268elapsedNowUwyO8pc() {
        return Duration.m7313minusLRDsOJo(this.mark.mo7268elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo7271plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m7314plusLRDsOJo(this.adjustment, duration), null);
    }
}
