...
public interface TimeMark {
    ...
    TimeMark mo7269minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo7271plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7416plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m7415minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo7271plusLRDsOJo(Duration.m7331unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m7311isNegativeimpl(timeMark.mo7268elapsedNowUwyO8pc());
        }
