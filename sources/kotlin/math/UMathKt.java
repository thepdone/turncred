...
public final class UMathKt {
    ...
    private static final int m7149minJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m7131minOfJ1ME1BU(i, i2);
    }

    /* renamed from: min-eb3DHEI, reason: not valid java name */
    private static final long m7150mineb3DHEI(long j, long j2) {
        return UComparisonsKt.m7139minOfeb3DHEI(j, j2);
    }

    /* renamed from: max-J1ME1BU, reason: not valid java name */
    private static final int m7147maxJ1ME1BU(int i, int i2) {
        return UComparisonsKt.m7119maxOfJ1ME1BU(i, i2);
    }

    /* renamed from: max-eb3DHEI, reason: not valid java name */
    private static final long m7148maxeb3DHEI(long j, long j2) {
        return UComparisonsKt.m7127maxOfeb3DHEI(j, j2);
    }
}
