...
public final class ReflectionObjectRenderer {
    ...
    public final String renderFunction(FunctionDescriptor descriptor) {
        ...
        CollectionsKt.joinTo(valueParameters, sb, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 2) != 0 ? ", " : ", ", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 4) != 0 ? "" : "(", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 8) != 0 ? "" : ")", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 16) != 0 ? -1 : 0, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 32) != 0 ? "..." : null, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 64) != 0 ? null : new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderFunction$1$1
    ...
    public final String renderLambda(FunctionDescriptor invoke) {
        ...
        Intrinsics.checkNotNullExpressionValue(valueParameters, "getValueParameters(...)");
        CollectionsKt.joinTo(valueParameters, sb, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 2) != 0 ? ", " : ", ", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 4) != 0 ? "" : "(", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 8) != 0 ? "" : ")", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 16) != 0 ? -1 : 0, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 32) != 0 ? "..." : null, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 64) != 0 ? null : new Function1<ValueParameterDescriptor, CharSequence>() { // from class: kotlin.reflect.jvm.internal.ReflectionObjectRenderer$renderLambda$1$1
            @Override // kotlin.jvm.functions.Function1
            public final CharSequence invoke(ValueParameterDescriptor valueParameterDescriptor) {
                ReflectionObjectRenderer reflectionObjectRenderer2 = ReflectionObjectRenderer.INSTANCE;
                KotlinType type = valueParameterDescriptor.getType();
