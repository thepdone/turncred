        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarkerPop)) {
                ...
                if (none == null) {
                    ...
                    while (it.hasNext()) {
                        SimpleTypeMarker simpleTypeMarkerMo7220transformType = none.mo7220transformType(typeCheckerState, it.next());
                        if ((typeSystemContext.isClassType(simpleTypeMarkerMo7220transformType) && !typeSystemContext.isMarkedNullable(simpleTypeMarkerMo7220transformType)) || typeSystemContext.isDefinitelyNotNullType(simpleTypeMarkerMo7220transformType)) {
        ...
        while (!supertypesDeque.isEmpty()) {
            ...
            if (supertypesSet.add(simpleTypeMarkerPop)) {
                ...
                if (supertypesPolicy == null) {
                    ...
                    Iterator<KotlinTypeMarker> it = typeSystemContext2.supertypes(typeSystemContext2.typeConstructor(simpleTypeMarkerPop)).iterator();
                    while (it.hasNext()) {
                        SimpleTypeMarker simpleTypeMarkerMo7220transformType = supertypesPolicy.mo7220transformType(state, it.next());
                        if (INSTANCE.isApplicableAsEndNode(state, simpleTypeMarkerMo7220transformType, end)) {
                            state.clear();
                            return true;
                        }
                        supertypesDeque.add(simpleTypeMarkerMo7220transformType);
