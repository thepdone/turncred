...
public final class DescriptorBasedTypeSignatureMappingKt {
    ...
    public static final <T> T mapType(KotlinType kotlinType, JvmTypeFactory<T> factory, TypeMappingMode mode, TypeMappingConfiguration<? extends T> typeMappingConfiguration, JvmDescriptorTypeWriter<T> jvmDescriptorTypeWriter, Function3<? super KotlinType, ? super T, ? super TypeMappingMode, Unit> writeGenericType) {
        ...
        if (constructor instanceof IntersectionTypeConstructor) {
            ...
            if (alternativeType == null) {
                alternativeType = typeMappingConfiguration.commonSupertype(intersectionTypeConstructor.mo7217getSupertypes());
            }
        ...
        if (ErrorUtils.isError(classifierDescriptor)) {
            ...
            typeMappingConfiguration.processErrorType(kotlinType, (ClassDescriptor) classifierDescriptorMo7216getDeclarationDescriptor);
            if (jvmDescriptorTypeWriter != 0) {
                jvmDescriptorTypeWriter.writeClass(t2);
            }
            return t2;
        }
        boolean z = classifierDescriptorMo7216getDeclarationDescriptor instanceof ClassDescriptor;
        ...
        if (z) {
            ...
            if (mode.isForAnnotationParameter() && KotlinBuiltIns.isKClass((ClassDescriptor) classifierDescriptorMo7216getDeclarationDescriptor)) {
        ...
        if (classifierDescriptorMo7216getDeclarationDescriptor instanceof TypeParameterDescriptor) {
            KotlinType representativeUpperBound = TypeUtilsKt.getRepresentativeUpperBound((TypeParameterDescriptor) classifierDescriptorMo7216getDeclarationDescriptor);
            ...
            if (jvmDescriptorTypeWriter != 0) {
                Name name = classifierDescriptorMo7216getDeclarationDescriptor.getName();
                Intrinsics.checkNotNullExpressionValue(name, "getName(...)");
                jvmDescriptorTypeWriter.writeTypeVariable(name, t3);
            }
            return t3;
        }
        if ((classifierDescriptorMo7216getDeclarationDescriptor instanceof TypeAliasDescriptor) && mode.getMapTypeAliases()) {
            return (T) mapType(((TypeAliasDescriptor) classifierDescriptorMo7216getDeclarationDescriptor).getExpandedType(), factory, mode, typeMappingConfiguration, jvmDescriptorTypeWriter, writeGenericType);
        }
    ...
    public static final String computeInternalName(ClassDescriptor klass, TypeMappingConfiguration<?> typeMappingConfiguration) {
        ...
        if (containingDeclaration instanceof PackageFragmentDescriptor) {
            ...
            return sb.append(StringsKt.replace$default(strAsString, FilenameUtils.EXTENSION_SEPARATOR, IOUtils.DIR_SEPARATOR_UNIX, false, 4, (Object) null)).append(IOUtils.DIR_SEPARATOR_UNIX).append(identifier).toString();
        }
