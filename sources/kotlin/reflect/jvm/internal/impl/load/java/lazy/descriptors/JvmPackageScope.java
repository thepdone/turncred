...
public final class JvmPackageScope implements MemberScope {
    ...
    public ClassifierDescriptor mo7218getContributedClassifier(Name name, LookupLocation location) {
        ...
        ClassDescriptor classDescriptorMo7218getContributedClassifier = this.javaScope.mo7218getContributedClassifier(name, location);
        if (classDescriptorMo7218getContributedClassifier != null) {
            return classDescriptorMo7218getContributedClassifier;
        }
