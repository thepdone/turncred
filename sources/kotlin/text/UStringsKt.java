...
public final class UStringsKt {
    ...
    public static final String m7265toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m7267toStringolVBNx4(short s, int i) {
    ...
    public static final String m7266toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m7264toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m6032constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m5949boximpl(UByte.m5955constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m6032constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m6212boximpl(UShort.m6218constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM6032constructorimpl = UInt.m6032constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM6032constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM6032constructorimpl2 = UInt.m6032constructorimpl(i3 * iM6032constructorimpl);
            int iM6032constructorimpl3 = UInt.m6032constructorimpl(UInt.m6032constructorimpl(iDigitOf) + iM6032constructorimpl2);
            if (Integer.compareUnsigned(iM6032constructorimpl3, iM6032constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM6032constructorimpl3;
        }
        return UInt.m6026boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM6111constructorimpl = ULong.m6111constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM6111constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM6111constructorimpl2 = ULong.m6111constructorimpl(j * jM6111constructorimpl);
            long jM6111constructorimpl3 = ULong.m6111constructorimpl(ULong.m6111constructorimpl(UInt.m6032constructorimpl(r13) & 4294967295L) + jM6111constructorimpl2);
            if (Long.compareUnsigned(jM6111constructorimpl3, jM6111constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM6111constructorimpl3;
        }
        return ULong.m6105boximpl(j);
    }
}
