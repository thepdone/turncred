...
public final class MediaLibraryModule$definition$1$12$1$action$1$invoke$$inlined$withModuleScope$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public MediaLibraryModule$definition$1$12$1$action$1$invoke$$inlined$withModuleScope$1(Promise promise, Continuation continuation, MediaLibraryModule mediaLibraryModule, String str, String str2, boolean z, Promise promise2) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new MediaLibraryModule$definition$1$12$1$action$1$invoke$$inlined$withModuleScope$1(this.$promise, continuation, this.this$0, this.$albumName$inlined, this.$assetId$inlined, this.$copyAsset$inlined, this.$promise$inlined);
    }

    @Override // kotlin.jvm.functions.Function2
    public final Object invoke(CoroutineScope coroutineScope, Continuation<? super Unit> continuation) {
        return ((MediaLibraryModule$definition$1$12$1$action$1$invoke$$inlined$withModuleScope$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
