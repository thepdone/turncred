...
public final /* data */ class TakeSnapshotOptions {
    ...
    public final TakeSnapshotOptions copy(OutputFile file, int quality) {
    ...
    public TakeSnapshotOptions(OutputFile file, int i) {
        Intrinsics.checkNotNullParameter(file, "file");
        this.file = file;
        this.quality = i;
    }
    ...
    public static final class Companion {
        ...
        public final TakeSnapshotOptions fromJSValue(Context context, ReadableMap map) {
