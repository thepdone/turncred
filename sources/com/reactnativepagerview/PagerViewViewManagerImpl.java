...
public final class PagerViewViewManagerImpl {
    ...
    public final void removeViewAt(NestedScrollableHost parent, int index) throws ClassNotFoundException {
        Intrinsics.checkNotNullParameter(parent, "parent");
        final ViewPager2 viewPager = getViewPager(parent);
        ViewPagerAdapter viewPagerAdapter = (ViewPagerAdapter) viewPager.getAdapter();
        ...
        viewPager.post(new Runnable() { // from class: com.reactnativepagerview.PagerViewViewManagerImpl$$ExternalSyntheticLambda2
            ...
            public final void run() {
                PagerViewViewManagerImpl.removeViewAt$lambda$0(viewPager);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void removeViewAt$lambda$0(ViewPager2 pager) {
    ...
    public final void setInitialPage(final NestedScrollableHost host, int value) throws ClassNotFoundException {
        ...
        if (host.getInitialIndex() == null) {
            ...
            viewPager.post(new Runnable() { // from class: com.reactnativepagerview.PagerViewViewManagerImpl$$ExternalSyntheticLambda3
                @Override // java.lang.Runnable
                public final void run() {
                    PagerViewViewManagerImpl.setInitialPage$lambda$1(host);
                }
            });
        }
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void setInitialPage$lambda$1(NestedScrollableHost host) {
        Intrinsics.checkNotNullParameter(host, "$host");
        host.setDidSetInitialIndex(true);
    }
    ...
    public final void setPageMargin(NestedScrollableHost host, int margin) throws ClassNotFoundException {
        ...
        viewPager.setPageTransformer(new ViewPager2.PageTransformer() { // from class: com.reactnativepagerview.PagerViewViewManagerImpl$$ExternalSyntheticLambda0
            ...
            public final void transformPage(View view, float f) {
                PagerViewViewManagerImpl.setPageMargin$lambda$2(pixelFromDIP, viewPager, view, f);
            }
        });
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final void setPageMargin$lambda$2(int i, ViewPager2 pager, View page, float f) {
        Intrinsics.checkNotNullParameter(pager, "$pager");
    ...
    private final void refreshViewChildrenLayout(final View view) {
        view.post(new Runnable() { // from class: com.reactnativepagerview.PagerViewViewManagerImpl$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                PagerViewViewManagerImpl.refreshViewChildrenLayout$lambda$3(view);
            }
        });
    }
