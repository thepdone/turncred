...
final class zzvo extends zztw implements RandomAccess, zzvs, zzxa {
    private static final zzvo zza = new zzvo(new int[0], 0, false);
    private int[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzvoVar.zzb, 0, this.zzb, this.zzc, zzvoVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzvoVar.zzc) {
            return false;
        }
        int[] iArr = zzvoVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzvs zzd(int i) {
        if (i >= this.zzc) {
            return new zzvo(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzvo(int[] iArr, int i, boolean z) {
        super(z);
        this.zzb = iArr;
        this.zzc = i;
    }
