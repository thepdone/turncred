...
public final class zzcf implements EncoderConfig {
    ...
    private static final ObjectEncoder zzb = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_face_bundled.zzce
    ...
    public final zzcg zza() {
        return new zzcg(new HashMap(this.zzc), new HashMap(this.zzd), this.zze);
    }
