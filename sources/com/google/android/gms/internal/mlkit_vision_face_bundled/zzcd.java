...
final class zzcd implements ObjectEncoderContext {
    ...
    private final zzch zzi = new zzch(this);
    ...
    static {
        ...
        zzd = new ObjectEncoder() { // from class: com.google.android.gms.internal.mlkit_vision_face_bundled.zzcc
            @Override // com.google.firebase.encoders.Encoder
            public final void encode(Object obj, ObjectEncoderContext objectEncoderContext) throws IOException {
                zzcd.zzg((Map.Entry) obj, objectEncoderContext);
            }
        };
    }

    zzcd(OutputStream outputStream, Map map, Map map2, ObjectEncoder objectEncoder) {
    ...
    private static int zzh(FieldDescriptor fieldDescriptor) {
        zzcb zzcbVar = (zzcb) fieldDescriptor.getProperty(zzcb.class);
        if (zzcbVar != null) {
            return zzcbVar.zza();
        }
    ...
    private static zzcb zzj(FieldDescriptor fieldDescriptor) {
        zzcb zzcbVar = (zzcb) fieldDescriptor.getProperty(zzcb.class);
        if (zzcbVar != null) {
            return zzcbVar;
        }
    ...
    private final zzcd zzk(ObjectEncoder objectEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
    ...
    private final zzcd zzl(ValueEncoder valueEncoder, FieldDescriptor fieldDescriptor, Object obj, boolean z) throws IOException {
            ...
            if (obj instanceof CharSequence) {
                ...
                if (!(obj instanceof byte[])) {
                    ...
                    if (obj instanceof zzbz) {
                        zzd(fieldDescriptor, ((zzbz) obj).zza(), true);
                        return this;
                    }
    ...
    final zzcd zzd(FieldDescriptor fieldDescriptor, int i, boolean z) throws IOException {
        if (!z || i != 0) {
            zzcb zzcbVarZzj = zzj(fieldDescriptor);
            zzca zzcaVar = zzca.DEFAULT;
            int iOrdinal = zzcbVarZzj.zzb().ordinal();
            if (iOrdinal == 0) {
                zzn(zzcbVarZzj.zza() << 3);
                zzn(i);
            } else if (iOrdinal == 1) {
                zzn(zzcbVarZzj.zza() << 3);
                zzn((i + i) ^ (i >> 31));
            } else if (iOrdinal == 2) {
                zzn((zzcbVarZzj.zza() << 3) | 5);
    ...
    final zzcd zze(FieldDescriptor fieldDescriptor, long j, boolean z) throws IOException {
        if (!z || j != 0) {
            zzcb zzcbVarZzj = zzj(fieldDescriptor);
            zzca zzcaVar = zzca.DEFAULT;
            int iOrdinal = zzcbVarZzj.zzb().ordinal();
    ...
    final zzcd zzf(Object obj) throws IOException {
        if (obj == null) {
            return this;
        }
        ObjectEncoder objectEncoder = (ObjectEncoder) this.zzf.get(obj.getClass());
