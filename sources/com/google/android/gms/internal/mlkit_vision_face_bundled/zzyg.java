...
final class zzyg {
    ...
    public static void zzD(Object obj, long j, byte b) {
        zzyf zzyfVar = zzf;
        long j2 = (-4) & j;
        int i = zzyfVar.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzyfVar.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzE(Object obj, long j, byte b) {
        ...
        long j2 = (-4) & j;
        int i = (((int) j) & 3) << 3;
        zzyfVar.zza.putInt(obj, j2, ((255 & b) << i) | (zzyfVar.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static /* bridge */ /* synthetic */ void zzh(Throwable th) {
        Logger.getLogger(zzyg.class.getName()).logp(Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(th.toString()));
    }
