...
final class zzua extends zztw implements RandomAccess, zzvs, zzxa {
    private static final zzua zza = new zzua(new boolean[0], 0, false);
    private boolean[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzuaVar.zzb, 0, this.zzb, this.zzc, zzuaVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzuaVar.zzc) {
            return false;
        }
        boolean[] zArr = zzuaVar.zzb;
    ...
    public final int hashCode() {
        int iZza = 1;
        for (int i = 0; i < this.zzc; i++) {
            iZza = (iZza * 31) + zzvt.zza(this.zzb[i]);
        }
        return iZza;
    }
    ...
    public final /* bridge */ /* synthetic */ zzvs zzd(int i) {
        if (i >= this.zzc) {
            return new zzua(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzua(boolean[] zArr, int i, boolean z) {
        super(z);
        this.zzb = zArr;
        this.zzc = i;
    }
