...
final class zzvf extends zztw implements RandomAccess, zzvs, zzxa {
    private static final zzvf zza = new zzvf(new float[0], 0, false);
    private float[] zzb;
    private int zzc;
    ...
    public final boolean addAll(Collection collection) {
        ...
        System.arraycopy(zzvfVar.zzb, 0, this.zzb, this.zzc, zzvfVar.zzc);
        this.zzc = i3;
        this.modCount++;
        return true;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        if (this.zzc != zzvfVar.zzc) {
            return false;
        }
        float[] fArr = zzvfVar.zzb;
    ...
    public final /* bridge */ /* synthetic */ zzvs zzd(int i) {
        if (i >= this.zzc) {
            return new zzvf(Arrays.copyOf(this.zzb, i), this.zzc, true);
        }
    ...
    private zzvf(float[] fArr, int i, boolean z) {
        super(z);
        this.zzb = fArr;
        this.zzc = i;
    }
