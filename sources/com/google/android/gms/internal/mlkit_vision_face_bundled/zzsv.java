...
public final class zzsv {
    ...
    zzsv(Context context, String str) {
    ...
    public final synchronized void zzc(int i, int i2, long j, long j2) {
        ...
        this.zza.log(new TelemetryData(0, Arrays.asList(new MethodInvocation(25503, i2, 0, j, j2, null, null, 0, -1)))).addOnFailureListener(new OnFailureListener() { // from class: com.google.android.gms.internal.mlkit_vision_face_bundled.zzsu
