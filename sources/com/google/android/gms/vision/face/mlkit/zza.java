...
final class zza extends zztm {
    ...
    private final zzsv zzg;
    private long zzh = -1;

    zza(Context context, zzti zztiVar, FaceDetectorV2Jni faceDetectorV2Jni, zzb zzbVar) {
        this.zzb = context;
        this.zzc = zztiVar;
        ...
        this.zzd = (zzah) zzagVarZza.zzn();
        this.zze = faceDetectorV2Jni;
        this.zzf = zzbVar;
        this.zzg = zzsv.zza(context);
        zzj.zza(context);
    }
    ...
    */
    ...
    public final List zzb(IObjectWrapper iObjectWrapper, zzte zzteVar) throws Throwable {
        List listZzg;
        zzaf zzafVarZzc;
        ...
        if (iZzb == -1) {
            listZzg = zzg(com.google.android.gms.internal.mlkit_vision_face_bundled.zzd.zza((Bitmap) ObjectWrapper.unwrap(iObjectWrapper), true), zzteVar, 2);
        } else if (iZzb == 17) {
            listZzg = zzg((ByteBuffer) ObjectWrapper.unwrap(iObjectWrapper), zzteVar, 2);
        } else if (iZzb == 35) {
            ...
            listZzg = zzg((ByteBuffer) ObjectWrapper.unwrap(iObjectWrapper), zzteVar, 7);
        }
        List list = listZzg;
        this.zzf.zza(this.zzc, zzteVar, list, SystemClock.elapsedRealtime() - jElapsedRealtime);
