...
public final class zzoe {
    ...
    public final Bundle zza() {
        ...
        if (length > 0) {
            bundle.putString(zzjj.zza.AD_STORAGE.zze, str.charAt(0) == '1' ? PermissionsResponse.GRANTED_KEY : "denied");
        }
        if (str.length() > 3) {
            bundle.putString(zzjj.zza.AD_PERSONALIZATION.zze, (str.charAt(2) == '1' && str.charAt(3) == '1') ? PermissionsResponse.GRANTED_KEY : "denied");
        }
