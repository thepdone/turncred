...
public final class LongMath {
    ...
    public static long factorial(int i) {
        MathPreconditions.checkNonNegative(JWKParameterNames.RSA_MODULUS, i);
    ...
    public static long binomial(int i, int i2) {
        MathPreconditions.checkNonNegative(JWKParameterNames.RSA_MODULUS, i);
        MathPreconditions.checkNonNegative(JWKParameterNames.OCT_KEY_VALUE, i2);
    ...
    public static boolean isPrime(long j) {
        if (j < 2) {
            MathPreconditions.checkNonNegative(JWKParameterNames.RSA_MODULUS, j);
            return false;
        }
        if (j < 66) {
