...
public final class ContextSwitchDialog extends FacebookDialogBase<ContextSwitchContent, Result> {
    ...
    public void showImpl(ContextSwitchContent content, Object mode) throws JSONException, PackageManager.NameNotFoundException {
        Intrinsics.checkNotNullParameter(content, "content");
    ...
    private final class WebHandler extends FacebookDialogBase<ContextSwitchContent, Result>.ModeHandler {
        ...
        @Override // com.facebook.internal.FacebookDialogBase.ModeHandler
        public AppCall createAppCall(ContextSwitchContent content) throws PackageManager.NameNotFoundException {
            Intrinsics.checkNotNullParameter(content, "content");
