...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM5937constructorimpl = Result.m5937constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5937constructorimpl = Result.m5937constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m5943isFailureimpl(objM5937constructorimpl) ? null : objM5937constructorimpl);
