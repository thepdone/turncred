...
public final class FlowKt__LimitKt$take$$inlined$unsafeFlow$1<T> implements Flow<T> {
    ...
    @DebugMetadata(c = "kotlinx.coroutines.flow.FlowKt__LimitKt$take$$inlined$unsafeFlow$1", f = "Limit.kt", i = {0}, l = {OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS}, m = "collect", n = {"ownershipMarker"}, s = {"L$0"})
