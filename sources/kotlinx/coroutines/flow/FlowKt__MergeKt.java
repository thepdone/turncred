...
final /* synthetic */ class FlowKt__MergeKt {
    ...
    static final class C06421<R, T> extends SuspendLambda implements Function3<FlowCollector<? super R>, T, Continuation<? super Unit>, Object> {
        ...
        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        /* JADX WARN: Multi-variable type inference failed */
        C06421(Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2, Continuation<? super C06421> continuation) {
            super(3, continuation);
            this.$transform = function2;
        }
        ...
        public final Object invoke(FlowCollector<? super R> flowCollector, T t, Continuation<? super Unit> continuation) {
            C06421 c06421 = new C06421(this.$transform, continuation);
            c06421.L$0 = flowCollector;
            c06421.L$1 = t;
            return c06421.invokeSuspend(Unit.INSTANCE);
        }
    ...
    public static final <T, R> Flow<R> mapLatest(Flow<? extends T> flow, Function2<? super T, ? super Continuation<? super R>, ? extends Object> function2) {
        return FlowKt.transformLatest(flow, new C06421(function2, null));
    }
