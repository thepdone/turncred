...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo7523scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m7444delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m7445toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m7445toDelayMillisLRDsOJo(long j) {
        boolean zM7312isPositiveimpl = Duration.m7312isPositiveimpl(j);
        if (zM7312isPositiveimpl) {
            Duration.Companion companion = Duration.INSTANCE;
            return Duration.m7296getInWholeMillisecondsimpl(Duration.m7314plusLRDsOJo(j, DurationKt.toDuration(999999L, DurationUnit.NANOSECONDS)));
        }
        if (zM7312isPositiveimpl) {
