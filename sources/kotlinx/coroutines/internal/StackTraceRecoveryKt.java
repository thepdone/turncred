...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        Object objM5937constructorimpl2;
        ...
        try {
            ...
            objM5937constructorimpl = Result.m5937constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM5937constructorimpl = Result.m5937constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m5940exceptionOrNullimpl(objM5937constructorimpl) == null) {
            obj2 = objM5937constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM5937constructorimpl2 = Result.m5937constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM5937constructorimpl2 = Result.m5937constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m5940exceptionOrNullimpl(objM5937constructorimpl2) == null) {
            obj = objM5937constructorimpl2;
        }
