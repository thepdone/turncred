...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m7471boximpl(Result.m5944isSuccessimpl(objM5937constructorimpl) ? ChannelResult.INSTANCE.m7486successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m7484closedJP2dKIU(Result.m5940exceptionOrNullimpl(objM5937constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo7456trySendJP2dKIU = sendChannel.mo7456trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m7481isSuccessimpl(sendChannel.mo7456trySendJP2dKIU(obj))) {
            return;
        }
