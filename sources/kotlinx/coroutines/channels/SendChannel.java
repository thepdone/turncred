...
public interface SendChannel<E> {
    ...
    Object mo7456trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m7481isSuccessimpl(objMo7456trySendJP2dKIU)) {
                return true;
            }
            Throwable thM7475exceptionOrNullimpl = ChannelResult.m7475exceptionOrNullimpl(objMo7456trySendJP2dKIU);
