...
public final class Sentry {
    ...
    public static IHub getCurrentHub() {
        ...
        IHub iHubM5833clone = mainHub.m5833clone();
        threadLocal.set(iHubM5833clone);
        return iHubM5833clone;
    }
    ...
    private static boolean initConfigurations(SentryOptions sentryOptions) throws IllegalArgumentException {
