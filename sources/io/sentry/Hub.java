...
public final class Hub implements IHub, MetricsApi.IMetricsInterface {
            ...
            if (z) {
                executorService.submit(new Runnable() { // from class: io.sentry.Hub$$ExternalSyntheticLambda1
                    ...
                    public final void run() {
                        this.f$0.m5829lambda$close$1$iosentryHub(executorService);
                    }
                });
            } else {
    ...
    /* synthetic */ void m5829lambda$close$1$iosentryHub(ISentryExecutorService iSentryExecutorService) {
    ...
    public void pushScope() {
        ...
        Stack.StackItem stackItemPeek = this.stack.peek();
        this.stack.push(new Stack.StackItem(this.options, stackItemPeek.getClient(), stackItemPeek.getScope().m5834clone()));
    }
    ...
    private IScope buildLocalScope(IScope iScope, ScopeCallback scopeCallback) {
        if (scopeCallback != null) {
            try {
                IScope iScopeM5836clone = iScope.m5834clone();
                scopeCallback.run(iScopeM5836clone);
                return iScopeM5836clone;
            } catch (Throwable th) {
