...
final class GroupKind {
    ...
    private static final int Group = m1738constructorimpl(0);
    private static final int Node = m1738constructorimpl(1);
    private static final int ReusableNode = m1738constructorimpl(2);
    private final int value;

    /* renamed from: box-impl, reason: not valid java name */
    public static final /* synthetic */ GroupKind m1737boximpl(int i) {
        return new GroupKind(i);
    }

    /* renamed from: constructor-impl, reason: not valid java name */
    private static int m1738constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl, reason: not valid java name */
    public static boolean m1739equalsimpl(int i, Object obj) {
        return (obj instanceof GroupKind) && i == ((GroupKind) obj).m1745unboximpl();
    }
    ...
    public static final boolean m1742isNodeimpl(int i) {
        return i != INSTANCE.m1746getGroupULZAiWs();
    }

    /* renamed from: isReusable-impl, reason: not valid java name */
    public static final boolean m1743isReusableimpl(int i) {
        return i != INSTANCE.m1747getNodeULZAiWs();
    }
    ...
    public static final class Companion {
        ...
        public final int m1746getGroupULZAiWs() {
            return GroupKind.Group;
        }

        /* renamed from: getNode-ULZAiWs, reason: not valid java name */
        public final int m1747getNodeULZAiWs() {
            return GroupKind.Node;
        }

        /* renamed from: getReusableNode-ULZAiWs, reason: not valid java name */
        public final int m1748getReusableNodeULZAiWs() {
