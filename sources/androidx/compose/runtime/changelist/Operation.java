...
public abstract class Operation {
    ...
    public String mo1781intParamNamew8GmfQM(int parameter) {
        return "IntParameter(" + parameter + ')';
    }

    /* renamed from: objectParamName-31yXWZQ, reason: not valid java name */
    public String mo1782objectParamName31yXWZQ(int parameter) {
    ...
    public static final class IntParameter {
        ...
        public static final /* synthetic */ IntParameter m1808boximpl(int i) {
        ...
        public static boolean m1810equalsimpl(int i, Object obj) {
            return (obj instanceof IntParameter) && i == ((IntParameter) obj).m1814unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m1810equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m1812hashCodeimpl(this.offset);
        }

        public String toString() {
            return m1813toStringimpl(this.offset);
        }
    ...
    /* compiled from: Operation.kt */
    @Metadata(d1 = {"\u0000$\n\u0002\u0018\u0002\n\u0000\n\u0002\u0010\u0000\n\u0000\n\u0002\u0010\b\n\u0002\b\u0005\n\u0002\u0010\u000b\n\u0002\b\u0006\n\u0002\u0010\u000e\n\u0002\b\u0003\b\u0087@\u0018\u0000*\u0004\b\u0000\u0010\u00012\u00020\u0002B\u000f\u0012\u0006\u0010\u0003\u001a\u00020\u0004¢\u0006\u0004\b\u0005\u0010\u0006J\u001a\u0010\t\u001a\u00020\n2\b\u0010\u000b\u001a\u0004\u0018\u00010\u0002HÖ\u0003¢\u0006\u0004\b\f\u0010\rJ\u0010\u0010\u000e\u001a\u00020\u0004HÖ\u0001¢\u0006\u0004\b\u000f\u0010\u0006J\u0010\u0010\u0010\u001a\u00020\u0011HÖ\u0001¢\u0006\u0004\b\u0012\u0010\u0013R\u0011\u0010\u0003\u001a\u00020\u0004¢\u0006\b\n\u0000\u001a\u0004\b\u0007\u0010\b\u0088\u0001\u0003¨\u0006\u0014"}, d2 = {"Landroidx/compose/runtime/changelist/Operation$ObjectParameter;", ExifInterface.GPS_DIRECTION_TRUE, "", "offset", "", "constructor-impl", "(I)I", "getOffset", "()I", "equals", "", "other", "equals-impl", "(ILjava/lang/Object;)Z", "hashCode", "hashCode-impl", InAppPurchaseConstants.METHOD_TO_STRING, "", "toString-impl", "(I)Ljava/lang/String;", "runtime_release"}, k = 1, mv = {1, 8, 0}, xi = 48)
    @JvmInline
    public static final class ObjectParameter<T> {
        private final int offset;

        /* renamed from: box-impl, reason: not valid java name */
        public static final /* synthetic */ ObjectParameter m1819boximpl(int i) {
            return new ObjectParameter(i);
        }

        /* renamed from: constructor-impl, reason: not valid java name */
        public static <T> int m1820constructorimpl(int i) {
            return i;
        }

        /* renamed from: equals-impl, reason: not valid java name */
        public static boolean m1821equalsimpl(int i, Object obj) {
            return (obj instanceof ObjectParameter) && i == ((ObjectParameter) obj).m1825unboximpl();
        }

        /* renamed from: equals-impl0, reason: not valid java name */
        public static final boolean m1822equalsimpl0(int i, int i2) {
            return i == i2;
        }
        ...
        /* renamed from: toString-impl, reason: not valid java name */
        public static String m1824toStringimpl(int i) {
            return "ObjectParameter(offset=" + i + ')';
        }

        public boolean equals(Object obj) {
            return m1821equalsimpl(this.offset, obj);
        }

        public int hashCode() {
            return m1823hashCodeimpl(this.offset);
        }

        public String toString() {
            return m1824toStringimpl(this.offset);
        }
    ...
    public static final class Ups extends Operation {
        ...
        public final int m1844getCountjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? "count" : super.mo1781intParamNamew8GmfQM(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int iMo1845getIntw8GmfQM = operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0));
            for (int i = 0; i < iMo1845getIntw8GmfQM; i++) {
                applier.up();
            }
        }
    }
    ...
    public static final class Downs extends Operation {
        ...
        public final int m1796getNodesHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            for (Object obj : (Object[]) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0))) {
                applier.down(obj);
            }
        }
        ...
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "nodes" : super.mo1782objectParamName31yXWZQ(parameter);
        }
    }
    ...
    public static final class AdvanceSlotsBy extends Operation {
        ...
        public final int m1783getDistancejn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? "distance" : super.mo1781intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.advanceBy(operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0)));
        }
    }
    ...
    public static final class SideEffect extends Operation {
        ...
        public final int m1834getEffectHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "effect" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.sideEffect((Function0) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0)));
        }
    }
    ...
    public static final class Remember extends Operation {
        ...
        public final int m1831getValueHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "value" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            rememberManager.remembering((RememberObserver) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0)));
        }
    }
    ...
    public static final class AppendValue extends Operation {
        ...
        public final int m1784getAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m1785getValueHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "anchor" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "value" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Anchor anchor = (Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
            Object objMo1846getObject31yXWZQ = operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            if (objMo1846getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo1846getObject31yXWZQ).getWrapped());
            }
            slotWriter.appendSlot(anchor, objMo1846getObject31yXWZQ);
        }
    }
    ...
    public static final class TrimParentValues extends Operation {
        ...
        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m1835getCountjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            for (int iMax = Math.max(iSlotsStartIndex$runtime_release, iSlotsEndIndex$runtime_release - iMo1845getIntw8GmfQM); iMax < iSlotsEndIndex$runtime_release; iMax++) {
            ...
            slotWriter.trimTailSlots(iMo1845getIntw8GmfQM);
        }
    }
    ...
    public static final class UpdateValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m1843getValueHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m1842getGroupSlotIndexjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? "groupSlotIndex" : super.mo1781intParamNamew8GmfQM(parameter);
        }
        ...
        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objMo1846getObject31yXWZQ = operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
            int iMo1845getIntw8GmfQM = operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0));
            if (objMo1846getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo1846getObject31yXWZQ).getWrapped());
            }
            Object obj = slotWriter.set(iMo1845getIntw8GmfQM, objMo1846getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                rememberManager.forgetting(((RememberObserverHolder) obj).getWrapped(), slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(slotWriter.getCurrentGroup(), iMo1845getIntw8GmfQM), -1, -1);
            } else if (obj instanceof RecomposeScopeImpl) {
                ((RecomposeScopeImpl) obj).release();
            }
        }
    ...
    public static final class UpdateAnchoredValue extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m1838getValueHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1836getAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }

        /* renamed from: getGroupSlotIndex-jn0FJLE, reason: not valid java name */
        public final int m1837getGroupSlotIndexjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "value" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "anchor" : super.mo1782objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            int slotsSize;
            Object objMo1846getObject31yXWZQ = operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            int iMo1845getIntw8GmfQM = operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0));
            if (objMo1846getObject31yXWZQ instanceof RememberObserverHolder) {
                rememberManager.remembering(((RememberObserverHolder) objMo1846getObject31yXWZQ).getWrapped());
            }
            int iAnchorIndex2 = slotWriter.anchorIndex(anchor);
            Object obj = slotWriter.set(iAnchorIndex2, iMo1845getIntw8GmfQM, objMo1846getObject31yXWZQ);
            if (obj instanceof RememberObserverHolder) {
                int slotsSize2 = slotWriter.getSlotsSize() - slotWriter.slotIndexOfGroupSlotIndex(iAnchorIndex2, iMo1845getIntw8GmfQM);
    ...
    public static final class UpdateAuxData extends Operation {
        ...
        public final int m1839getDataHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "data" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.updateAux(operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0)));
        }
    }
    ...
    public static final class EnsureGroupStarted extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1799getAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "anchor" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.ensureStarted((Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0)));
        }
    }
    ...
    public static final class MoveCurrentGroup extends Operation {
        ...
        public final int m1815getOffsetjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? "offset" : super.mo1781intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            slotWriter.moveGroup(operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0)));
        }
    }
    ...
    public static final class EndCompositionScope extends Operation {
        ...
        public final int m1797getActionHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m1798getCompositionHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "anchor" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "composition" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function1) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0))).invoke((Composition) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1)));
        }
    }
    ...
    public static final class UpdateNode extends Operation {
        ...
        /* renamed from: getValue-HpuvwBQ, reason: not valid java name */
        public final int m1841getValueHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getBlock-HpuvwBQ, reason: not valid java name */
        public final int m1840getBlockHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "value" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "block" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ((Function2) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1))).invoke(applier.getCurrent(), operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0)));
        }
    }
    ...
    public static final class RemoveNode extends Operation {
        ...
        public final int m1833getRemoveIndexjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m1832getCountjn0FJLE() {
            return IntParameter.m1809constructorimpl(1);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? "removeIndex" : IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(1)) ? "count" : super.mo1781intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.remove(operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0)), operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(1)));
        }
    }
    ...
    public static final class MoveNode extends Operation {
        ...
        public final int m1817getFromjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }

        /* renamed from: getTo-jn0FJLE, reason: not valid java name */
        public final int m1818getTojn0FJLE() {
            return IntParameter.m1809constructorimpl(1);
        }

        /* renamed from: getCount-jn0FJLE, reason: not valid java name */
        public final int m1816getCountjn0FJLE() {
            return IntParameter.m1809constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? Constants.MessagePayloadKeys.FROM : IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(1)) ? "to" : IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(2)) ? "count" : super.mo1781intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            applier.move(operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0)), operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(1)), operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(2)));
        }
    }
    ...
    public static final class InsertSlots extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1803getAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m1804getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "anchor" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? Constants.MessagePayloadKeys.FROM : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
    ...
    public static final class InsertSlotsWithFixups extends Operation {
        ...
        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1805getAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getFromSlotTable-HpuvwBQ, reason: not valid java name */
        public final int m1807getFromSlotTableHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }

        /* renamed from: getFixups-HpuvwBQ, reason: not valid java name */
        public final int m1806getFixupsHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(2);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "anchor" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? Constants.MessagePayloadKeys.FROM : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(2)) ? "fixups" : super.mo1782objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            SlotTable slotTable = (SlotTable) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            Anchor anchor = (Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
            FixupList fixupList = (FixupList) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(2));
    ...
    public static final class InsertNodeFixup extends Operation {
        ...
        public final int m1800getFactoryHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m1802getInsertIndexjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1801getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: intParamName-w8GmfQM */
        public String mo1781intParamNamew8GmfQM(int parameter) {
            return IntParameter.m1811equalsimpl0(parameter, IntParameter.m1809constructorimpl(0)) ? "insertIndex" : super.mo1781intParamNamew8GmfQM(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "factory" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "groupAnchor" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            Object objInvoke = ((Function0) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0))).invoke();
            Anchor anchor = (Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            int iMo1845getIntw8GmfQM = operationArgContainer.mo1845getIntw8GmfQM(IntParameter.m1809constructorimpl(0));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            slotWriter.updateNode(anchor, objInvoke);
            applier.insertTopDown(iMo1845getIntw8GmfQM, objInvoke);
    ...
    public static final class PostInsertNodeFixup extends Operation {
        ...
        /* renamed from: getInsertIndex-jn0FJLE, reason: not valid java name */
        public final int m1827getInsertIndexjn0FJLE() {
            return IntParameter.m1809constructorimpl(0);
        }

        /* renamed from: getGroupAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1826getGroupAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "groupAnchor" : super.mo1782objectParamName31yXWZQ(parameter);
        }
        ...
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            ...
            applier.up();
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
            applier.insertBottomUp(iMo1845getIntw8GmfQM, slotWriter.node(anchor));
        }
    }
    ...
    public static final class DetermineMovableContentNodeIndex extends Operation {
        ...
        public final int m1795getEffectiveNodeIndexOutHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getAnchor-HpuvwBQ, reason: not valid java name */
        public final int m1794getAnchorHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "effectiveNodeIndexOut" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "anchor" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
            Anchor anchor = (Anchor) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            Intrinsics.checkNotNull(applier, "null cannot be cast to non-null type androidx.compose.runtime.Applier<kotlin.Any?>");
    ...
    public static final class CopyNodesToNewAnchorLocation extends Operation {
        ...
        public final int m1788getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getNodes-HpuvwBQ, reason: not valid java name */
        public final int m1789getNodesHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "effectiveNodeIndex" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "nodes" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            int element = ((IntRef) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0))).getElement();
            List list = (List) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            int size = list.size();
    ...
    public static final class CopySlotTableToAnchorLocation extends Operation {
        ...
        public final int m1792getResolvedStateHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m1791getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }

        /* renamed from: getFrom-HpuvwBQ, reason: not valid java name */
        public final int m1790getFromHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(2);
        }

        /* renamed from: getTo-HpuvwBQ, reason: not valid java name */
        public final int m1793getToHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(3);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "resolvedState" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "resolvedCompositionContext" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(2)) ? Constants.MessagePayloadKeys.FROM : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(3)) ? "to" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            MovableContentStateReference movableContentStateReference = (MovableContentStateReference) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(2));
            MovableContentStateReference movableContentStateReference2 = (MovableContentStateReference) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(3));
            CompositionContext compositionContext = (CompositionContext) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            MovableContentState movableContentStateMovableContentStateResolve$runtime_release = (MovableContentState) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
    ...
    public static final class ReleaseMovableGroupAtCurrent extends Operation {
        ...
        /* renamed from: getComposition-HpuvwBQ, reason: not valid java name */
        public final int m1828getCompositionHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getParentCompositionContext-HpuvwBQ, reason: not valid java name */
        public final int m1829getParentCompositionContextHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }

        /* renamed from: getReference-HpuvwBQ, reason: not valid java name */
        public final int m1830getReferenceHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(2);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "composition" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "parentCompositionContext" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(2)) ? "reference" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            OperationKt.releaseMovableGroupAtCurrent((ControlledComposition) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0)), (CompositionContext) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1)), (MovableContentStateReference) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(2)), slotWriter);
        }
    }
    ...
    public static final class ApplyChangeList extends Operation {
        ...
        public final int m1786getChangesHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(0);
        }

        /* renamed from: getEffectiveNodeIndex-HpuvwBQ, reason: not valid java name */
        public final int m1787getEffectiveNodeIndexHpuvwBQ() {
            return ObjectParameter.m1820constructorimpl(1);
        }
        ...
        /* renamed from: objectParamName-31yXWZQ */
        public String mo1782objectParamName31yXWZQ(int parameter) {
            return ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(0)) ? "changes" : ObjectParameter.m1822equalsimpl0(parameter, ObjectParameter.m1820constructorimpl(1)) ? "effectiveNodeIndex" : super.mo1782objectParamName31yXWZQ(parameter);
        }

        @Override // androidx.compose.runtime.changelist.Operation
        public void execute(OperationArgContainer operationArgContainer, Applier<?> applier, SlotWriter slotWriter, RememberManager rememberManager) {
            IntRef intRef = (IntRef) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(1));
            int element = intRef != null ? intRef.getElement() : 0;
            ChangeList changeList = (ChangeList) operationArgContainer.mo1846getObject31yXWZQ(ObjectParameter.m1820constructorimpl(0));
            if (element > 0) {
    ...
    public static final class TestOperation extends Operation {
        ...
        public TestOperation(int i, int i2, Function3<? super Applier<?>, ? super SlotWriter, ? super RememberManager, Unit> function3) {
            ...
            for (int i3 = 0; i3 < i; i3++) {
                arrayList.add(IntParameter.m1808boximpl(IntParameter.m1809constructorimpl(i3)));
            }
            this.intParams = arrayList;
            ArrayList arrayList2 = new ArrayList(i2);
            for (int i4 = 0; i4 < i2; i4++) {
                arrayList2.add(ObjectParameter.m1819boximpl(ObjectParameter.m1820constructorimpl(i4)));
            }
