...
public final class VectorKt {
    ...
    private static final int DefaultStrokeLineCap = StrokeCap.INSTANCE.m2630getButtKaPHkGw();
    private static final int DefaultStrokeLineJoin = StrokeJoin.INSTANCE.m2641getMiterLxFBmk8();
    private static final int DefaultTintBlendMode = BlendMode.INSTANCE.m2216getSrcIn0nO6VwU();
    private static final long DefaultTintColor = Color.INSTANCE.m2311getTransparent0d7_KjU();
    private static final int DefaultFillType = PathFillType.INSTANCE.m2560getNonZeroRgk1Os();
    ...
    public static final boolean m2985rgbEqualOWjLjI(long j, long j2) {
        return Color.m2282getRedimpl(j) == Color.m2282getRedimpl(j2) && Color.m2281getGreenimpl(j) == Color.m2281getGreenimpl(j2) && Color.m2279getBlueimpl(j) == Color.m2279getBlueimpl(j2);
    }

    public static final boolean tintableWithAlphaMask(ColorFilter colorFilter) {
        if (colorFilter instanceof BlendModeColorFilter) {
            BlendModeColorFilter blendModeColorFilter = (BlendModeColorFilter) colorFilter;
            if (BlendMode.m2187equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m2216getSrcIn0nO6VwU()) || BlendMode.m2187equalsimpl0(blendModeColorFilter.getBlendMode(), BlendMode.INSTANCE.m2218getSrcOver0nO6VwU())) {
                return true;
            }
