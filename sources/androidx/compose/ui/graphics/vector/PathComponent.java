...
public final class PathComponent extends VNode {
    ...
    public final void m2975setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.mo2169setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final void m2976setStrokeLineCapBeK7IIE(int i) {
    ...
    public final void m2977setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual(this.renderPath, this.path)) {
            ...
            int iMo2167getFillTypeRgk1Os = this.renderPath.mo2167getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.mo2169setFillTypeoQ8Xj4U(iMo2167getFillTypeRgk1Os);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m2822drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, null, null, 0, 56, null);
        }
        ...
        if (brush2 != null) {
            ...
            DrawScope.m2822drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke, null, 0, 48, null);
        }
    }
