...
public final class VectorPainterKt {
    ...
    public static final VectorPainter m2996rememberVectorPaintermlNsNFs(float f, float f2, float f3, float f4, String str, long j, int i, Function4<? super Float, ? super Float, ? super Composer, ? super Integer, Unit> function4, Composer composer, int i2, int i3) {
        ...
        long jM2312getUnspecified0d7_KjU = (i3 & 32) != 0 ? Color.INSTANCE.m2312getUnspecified0d7_KjU() : j;
        int iM2216getSrcIn0nO6VwU = (i3 & 64) != 0 ? BlendMode.INSTANCE.m2216getSrcIn0nO6VwU() : i;
        ...
        VectorPainter vectorPainterM2997rememberVectorPaintervIP8VLU = m2997rememberVectorPaintervIP8VLU(f, f2, f5, f6, str2, jM2312getUnspecified0d7_KjU, iM2216getSrcIn0nO6VwU, false, function4, composer, (i2 & 14) | 12582912 | (i2 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | (i2 & 896) | (i2 & 7168) | (57344 & i2) | (458752 & i2) | (3670016 & i2) | ((i2 << 3) & 234881024), 0);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        return vectorPainterM2997rememberVectorPaintervIP8VLU;
    }

    /* JADX WARN: Removed duplicated region for block: B:77:0x015c A[PHI: r4
  0x015c: PHI (r4v16 kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit>) = 
 ...
 binds: [B:76:0x015a, B:72:0x0154] A[DONT_GENERATE, DONT_INLINE]] */
    ...
    */
    public static final androidx.compose.ui.graphics.vector.VectorPainter m2997rememberVectorPaintervIP8VLU(float r18, float r19, float r20, float r21, java.lang.String r22, long r23, int r25, boolean r26, kotlin.jvm.functions.Function4<? super java.lang.Float, ? super java.lang.Float, ? super androidx.compose.runtime.Composer, ? super java.lang.Integer, kotlin.Unit> r27, androidx.compose.runtime.Composer r28, int r29, int r30) {
        /*
            Method dump skipped, instructions count: 449
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.graphics.vector.VectorPainterKt.m2997rememberVectorPaintervIP8VLU(float, float, float, float, java.lang.String, long, int, boolean, kotlin.jvm.functions.Function4, androidx.compose.runtime.Composer, int, int):androidx.compose.ui.graphics.vector.VectorPainter");
    }
    ...
    private static final long m2994obtainSizePxVpY3zN4(Density density, float f, float f2) {
        return SizeKt.Size(density.mo694toPx0680j_4(f), density.mo694toPx0680j_4(f2));
    }

    /* renamed from: obtainViewportSize-Pq9zytI, reason: not valid java name */
    private static final long m2995obtainViewportSizePq9zytI(long j, float f, float f2) {
        if (Float.isNaN(f)) {
            f = Size.m2104getWidthimpl(j);
        }
        if (Float.isNaN(f2)) {
            f2 = Size.m2101getHeightimpl(j);
        }
        return SizeKt.Size(f, f2);
    }

    /* renamed from: createColorFilter-xETnrds, reason: not valid java name */
    private static final ColorFilter m2993createColorFilterxETnrds(long j, int i) {
        if (j != 16) {
            return ColorFilter.INSTANCE.m2320tintxETnrds(j, i);
        }
        return null;
    }

    /* renamed from: configureVectorPainter-T4PVSW8, reason: not valid java name */
    public static final VectorPainter m2991configureVectorPainterT4PVSW8(VectorPainter vectorPainter, long j, long j2, String str, ColorFilter colorFilter, boolean z) {
        vectorPainter.m2989setSizeuvyYCjk$ui_release(j);
        vectorPainter.setAutoMirror$ui_release(z);
        vectorPainter.setIntrinsicColorFilter$ui_release(colorFilter);
        vectorPainter.m2990setViewportSizeuvyYCjk$ui_release(j2);
    ...
    public static final VectorPainter createVectorPainterFromImageVector(Density density, ImageVector imageVector, GroupComponent groupComponent) {
        long jM2994obtainSizePxVpY3zN4 = m2994obtainSizePxVpY3zN4(density, imageVector.getDefaultWidth(), imageVector.getDefaultHeight());
        return m2991configureVectorPainterT4PVSW8(new VectorPainter(groupComponent), jM2994obtainSizePxVpY3zN4, m2995obtainViewportSizePq9zytI(jM2994obtainSizePxVpY3zN4, imageVector.getViewportWidth(), imageVector.getViewportHeight()), imageVector.getName(), m2993createColorFilterxETnrds(imageVector.getTintColor(), imageVector.getTintBlendMode()), imageVector.getAutoMirror());
    }
    ...
    public static final GroupComponent createGroupComponent(GroupComponent groupComponent, VectorGroup vectorGroup) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (vectorNode instanceof VectorPath) {
                ...
                pathComponent.m2975setPathFillTypeoQ8Xj4U(vectorPath.getPathFillType());
                ...
                pathComponent.m2976setStrokeLineCapBeK7IIE(vectorPath.getStrokeLineCap());
                pathComponent.m2977setStrokeLineJoinWw9F2mQ(vectorPath.getStrokeLineJoin());
