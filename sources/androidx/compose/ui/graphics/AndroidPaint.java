...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(android.graphics.Paint paint) {
        ...
        this._blendMode = BlendMode.INSTANCE.m2218getSrcOver0nO6VwU();
    }
    ...
    public long mo2149getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setColor-8_81llA, reason: not valid java name */
    public void mo2155setColor8_81llA(long j) {
        AndroidPaint_androidKt.m2161setNativeColor4WTKRHQ(this.internalPaint, j);
    }
    ...
    public void mo2154setBlendModes9anfk8(int i) {
        if (BlendMode.m2187equalsimpl0(this._blendMode, i)) {
            return;
        }
        this._blendMode = i;
        AndroidPaint_androidKt.m2160setNativeBlendModeGB0RdKg(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStyle-TiuSbCo, reason: not valid java name */
    public int mo2153getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStyle-k9PVt8s, reason: not valid java name */
    public void mo2159setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m2165setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int mo2151getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeCap-BeK7IIE, reason: not valid java name */
    public void mo2157setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m2163setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: getStrokeJoin-LxFBmk8, reason: not valid java name */
    public int mo2152getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setStrokeJoin-Ww9F2mQ, reason: not valid java name */
    public void mo2158setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m2164setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int mo2150getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    @Override // androidx.compose.ui.graphics.Paint
    /* renamed from: setFilterQuality-vDHp3xo, reason: not valid java name */
    public void mo2156setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m2162setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
