...
public final class GraphicsViewLayer implements GraphicsLayerImpl {
    ...
    public GraphicsViewLayer(DrawChildContainer drawChildContainer, long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.alpha = 1.0f;
        this.pivotOffset = Offset.INSTANCE.m2051getZeroF1C5BW0();
        this.scaleX = 1.0f;
        this.scaleY = 1.0f;
    ...
    private final void m2950applyCompositingLayerWpw9cng(int compositingStrategy) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m2950applyCompositingLayerWpw9cng(CompositingStrategy.INSTANCE.m2915getOffscreenke2Ky5w());
        } else {
            m2950applyCompositingLayerWpw9cng(getCompositingStrategy());
        }
    }
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m2909equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m2915getOffscreenke2Ky5w()) || requiresLayerPaint();
    }

    private final boolean requiresLayerPaint() {
        return (BlendMode.m2187equalsimpl0(getBlendMode(), BlendMode.INSTANCE.m2218getSrcOver0nO6VwU()) && getColorFilter() == null) ? false : true;
    }
    ...
    public void mo2945setPivotOffsetk4lQ0M(long j) {
        ...
        if (OffsetKt.m2056isUnspecifiedk4lQ0M(j)) {
            ...
            this.viewLayer.setPivotX(IntSize.m4907getWidthimpl(this.size) / 2.0f);
            this.viewLayer.setPivotY(IntSize.m4906getHeightimpl(this.size) / 2.0f);
            return;
        }
        this.shouldManuallySetCenterPivot = false;
        this.viewLayer.setPivotX(Offset.m2035getXimpl(j));
        this.viewLayer.setPivotY(Offset.m2036getYimpl(j));
    }
    ...
    public void mo2941setAmbientShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineAmbientShadowColor(this.viewLayer, ColorKt.m2330toArgb8_81llA(j));
        }
    }
    ...
    public void mo2947setSpotShadowColor8_81llA(long j) {
        if (Build.VERSION.SDK_INT >= 28) {
            ...
            ViewLayerVerificationHelper28.INSTANCE.setOutlineSpotShadowColor(this.viewLayer, ColorKt.m2330toArgb8_81llA(j));
        }
    }
    ...
    public void mo2946setPositionH0pRuoY(int x, int y, long size) {
        if (!IntSize.m4905equalsimpl0(this.size, size)) {
            ...
            this.viewLayer.layout(x, y, IntSize.m4907getWidthimpl(size) + x, IntSize.m4906getHeightimpl(size) + y);
            this.size = size;
            if (this.shouldManuallySetCenterPivot) {
                this.viewLayer.setPivotX(IntSize.m4907getWidthimpl(size) / 2.0f);
                this.viewLayer.setPivotY(IntSize.m4906getHeightimpl(size) / 2.0f);
            }
        } else {
            int i = this.x;
            if (i != x) {
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        if (this.viewLayer.isAttachedToWindow()) {
            ...
            if (picture != null) {
                Canvas canvasBeginRecording = picture.beginRecording(IntSize.m4907getWidthimpl(this.size), IntSize.m4906getHeightimpl(this.size));
                try {
