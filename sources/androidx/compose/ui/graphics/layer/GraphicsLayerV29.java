...
public final class GraphicsLayerV29 implements GraphicsLayerImpl {
    ...
    public GraphicsLayerV29(long j, CanvasHolder canvasHolder, CanvasDrawScope canvasDrawScope) {
        ...
        this.size = Size.INSTANCE.m2113getZeroNHjbRc();
        renderNode.setClipToBounds(false);
        m2949applyCompositingStrategyZ1X6vPc(renderNode, CompositingStrategy.INSTANCE.m2913getAutoke2Ky5w());
        this.alpha = 1.0f;
    ...
    public void mo2942setBlendModes9anfk8(int i) {
        this.blendMode = i;
        obtainLayerPaint().setBlendMode(AndroidBlendMode_androidKt.m2127toAndroidBlendModes9anfk8(i));
    ...
    public void mo2941setAmbientShadowColor8_81llA(long j) {
        ...
        this.renderNode.setAmbientShadowColor(ColorKt.m2330toArgb8_81llA(j));
    }
    ...
    public void mo2947setSpotShadowColor8_81llA(long j) {
        ...
        this.renderNode.setSpotShadowColor(ColorKt.m2330toArgb8_81llA(j));
    }
    ...
    private final void m2949applyCompositingStrategyZ1X6vPc(RenderNode renderNode, int i) {
        if (CompositingStrategy.m2909equalsimpl0(i, CompositingStrategy.INSTANCE.m2915getOffscreenke2Ky5w())) {
            renderNode.setUseCompositingLayer(true, this.layerPaint);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2909equalsimpl0(i, CompositingStrategy.INSTANCE.m2914getModulateAlphake2Ky5w())) {
    ...
    private final void updateLayerProperties() {
        if (requiresCompositingLayer()) {
            m2949applyCompositingStrategyZ1X6vPc(this.renderNode, CompositingStrategy.INSTANCE.m2915getOffscreenke2Ky5w());
        } else {
            m2949applyCompositingStrategyZ1X6vPc(this.renderNode, getCompositingStrategy());
        }
    }
    ...
    public void mo2946setPositionH0pRuoY(int x, int y, long size) {
        this.renderNode.setPosition(x, y, IntSize.m4907getWidthimpl(size) + x, IntSize.m4906getHeightimpl(size) + y);
        this.size = IntSizeKt.m4919toSizeozmzZPI(size);
    }
    ...
    public void record(Density density, LayoutDirection layoutDirection, GraphicsLayer layer, Function1<? super DrawScope, Unit> block) {
        ...
        try {
            ...
            drawContext.mo2755setSizeuvyYCjk(this.size);
    ...
    private final boolean requiresCompositingLayer() {
        return CompositingStrategy.m2909equalsimpl0(getCompositingStrategy(), CompositingStrategy.INSTANCE.m2915getOffscreenke2Ky5w()) || requiresLayerPaint() || getRenderEffect() != null;
    }
