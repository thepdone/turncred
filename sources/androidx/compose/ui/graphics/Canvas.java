...
public interface Canvas {
    ...
    void mo2132drawCircle9KIMszo(long center, float radius, Paint paint);

    /* renamed from: drawImage-d-4ec7I */
    void mo2133drawImaged4ec7I(ImageBitmap image, long topLeftOffset, Paint paint);

    /* renamed from: drawImageRect-HPBpro0 */
    void mo2134drawImageRectHPBpro0(ImageBitmap image, long srcOffset, long srcSize, long dstOffset, long dstSize, Paint paint);

    /* renamed from: drawLine-Wko1d7g */
    void mo2135drawLineWko1d7g(long p1, long p2, Paint paint);
    ...
    void mo2136drawPointsO7TthRY(int pointMode, List<Offset> points, Paint paint);

    /* renamed from: drawRawPoints-O7TthRY */
    void mo2137drawRawPointsO7TthRY(int pointMode, float[] points, Paint paint);
    ...
    void mo2138drawVerticesTPEHhCM(Vertices vertices, int blendMode, Paint paint);
    ...
    public static final class DefaultImpls {
        ...
        public static void m2254clipRectmtrdDE(Canvas canvas, Rect rect, int i) {
            Canvas.super.m2251clipRectmtrdDE(rect, i);
        }
    ...
    static /* synthetic */ void m2249clipRectmtrdDE$default(Canvas canvas, Rect rect, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.m2251clipRectmtrdDE(rect, i);
    }

    /* renamed from: clipRect-mtrdD-E, reason: not valid java name */
    default void m2251clipRectmtrdDE(Rect rect, int clipOp) {
        mo2130clipRectN_I0leg(rect.getLeft(), rect.getTop(), rect.getRight(), rect.getBottom(), clipOp);
    }

    /* renamed from: clipRect-N_I0leg$default, reason: not valid java name */
    static /* synthetic */ void m2248clipRectN_I0leg$default(Canvas canvas, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2130clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E$default, reason: not valid java name */
    static /* synthetic */ void m2247clipPathmtrdDE$default(Canvas canvas, Path path, int i, int i2, Object obj) {
        if (obj != null) {
        ...
        canvas.mo2129clipPathmtrdDE(path, i);
    }
    ...
    static /* synthetic */ void m2250drawImageRectHPBpro0$default(Canvas canvas, ImageBitmap imageBitmap, long j, long j2, long j3, long j4, Paint paint, int i, Object obj) {
        if (obj != null) {
            throw new UnsupportedOperationException("Super calls with default arguments not supported in this target, function: drawImageRect-HPBpro0");
        }
        long jM4875getZeronOccac = (i & 2) != 0 ? IntOffset.INSTANCE.m4875getZeronOccac() : j;
        long jIntSize = (i & 4) != 0 ? IntSizeKt.IntSize(imageBitmap.getWidth(), imageBitmap.getHeight()) : j2;
        canvas.mo2134drawImageRectHPBpro0(imageBitmap, jM4875getZeronOccac, jIntSize, (i & 8) != 0 ? IntOffset.INSTANCE.m4875getZeronOccac() : j3, (i & 16) != 0 ? jIntSize : j4, paint);
    }
}
