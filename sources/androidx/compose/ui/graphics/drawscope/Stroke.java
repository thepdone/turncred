...
public final class Stroke extends DrawStyle {
    ...
    private static final int DefaultCap = StrokeCap.INSTANCE.m2630getButtKaPHkGw();
    private static final int DefaultJoin = StrokeJoin.INSTANCE.m2641getMiterLxFBmk8();
    ...
    public static final class Companion {
        ...
        public final int m2904getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8, reason: not valid java name */
        public final int m2905getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object other) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m2626equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m2636equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual(this.pathEffect, stroke.pathEffect);
    }

    public int hashCode() {
        int iHashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m2627hashCodeimpl(this.cap)) * 31) + StrokeJoin.m2637hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect = this.pathEffect;
        return iHashCode + (pathEffect != null ? pathEffect.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + ((Object) StrokeCap.m2628toStringimpl(this.cap)) + ", join=" + ((Object) StrokeJoin.m2638toStringimpl(this.join)) + ", pathEffect=" + this.pathEffect + ')';
    }
}
