...
public final class AndroidPaint_androidKt {
    ...
    public static final void m2160setNativeBlendModeGB0RdKg(android.graphics.Paint paint, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            WrapperVerificationHelperMethods.INSTANCE.m2680setBlendModeGB0RdKg(paint, i);
        } else {
            paint.setXfermode(new PorterDuffXfermode(AndroidBlendMode_androidKt.m2128toPorterDuffModes9anfk8(i)));
        }
    }
    ...
    public static final void m2161setNativeColor4WTKRHQ(android.graphics.Paint paint, long j) {
        paint.setColor(ColorKt.m2330toArgb8_81llA(j));
    }

    /* renamed from: setNativeStyle--5YerkU, reason: not valid java name */
    public static final void m2165setNativeStyle5YerkU(android.graphics.Paint paint, int i) {
        paint.setStyle(PaintingStyle.m2540equalsimpl0(i, PaintingStyle.INSTANCE.m2545getStrokeTiuSbCo()) ? Paint.Style.STROKE : Paint.Style.FILL);
    }
    ...
    public static final int getNativeStyle(android.graphics.Paint paint) {
        ...
        if ((style == null ? -1 : WhenMappings.$EnumSwitchMapping$0[style.ordinal()]) == 1) {
            return PaintingStyle.INSTANCE.m2545getStrokeTiuSbCo();
        }
        return PaintingStyle.INSTANCE.m2544getFillTiuSbCo();
    }
    ...
    public static final int getNativeStrokeCap(android.graphics.Paint paint) {
        ...
        if (i == 3) {
            return StrokeCap.INSTANCE.m2632getSquareKaPHkGw();
        }
        return StrokeCap.INSTANCE.m2630getButtKaPHkGw();
    }

    /* renamed from: setNativeStrokeCap-CSYIeUk, reason: not valid java name */
    public static final void m2163setNativeStrokeCapCSYIeUk(android.graphics.Paint paint, int i) {
        Paint.Cap cap;
        if (StrokeCap.m2626equalsimpl0(i, StrokeCap.INSTANCE.m2632getSquareKaPHkGw())) {
            cap = Paint.Cap.SQUARE;
        } else if (StrokeCap.m2626equalsimpl0(i, StrokeCap.INSTANCE.m2631getRoundKaPHkGw())) {
            cap = Paint.Cap.ROUND;
        } else {
            cap = StrokeCap.m2626equalsimpl0(i, StrokeCap.INSTANCE.m2630getButtKaPHkGw()) ? Paint.Cap.BUTT : Paint.Cap.BUTT;
        }
    ...
    public static final int getNativeStrokeJoin(android.graphics.Paint paint) {
        ...
        if (i == 2) {
            return StrokeJoin.INSTANCE.m2640getBevelLxFBmk8();
        }
        if (i == 3) {
    ...
    public static final void m2164setNativeStrokeJoinkLtJ_vA(android.graphics.Paint paint, int i) {
        Paint.Join join;
        if (StrokeJoin.m2636equalsimpl0(i, StrokeJoin.INSTANCE.m2641getMiterLxFBmk8())) {
            join = Paint.Join.MITER;
        } else if (StrokeJoin.m2636equalsimpl0(i, StrokeJoin.INSTANCE.m2640getBevelLxFBmk8())) {
            join = Paint.Join.BEVEL;
        } else {
            join = StrokeJoin.m2636equalsimpl0(i, StrokeJoin.INSTANCE.m2642getRoundLxFBmk8()) ? Paint.Join.ROUND : Paint.Join.MITER;
        }
    ...
    public static final int getNativeFilterQuality(android.graphics.Paint paint) {
        if (!paint.isFilterBitmap()) {
            return FilterQuality.INSTANCE.m2379getNonefv9h1I();
        }
        return FilterQuality.INSTANCE.m2377getLowfv9h1I();
    }

    /* renamed from: setNativeFilterQuality-50PEsBU, reason: not valid java name */
    public static final void m2162setNativeFilterQuality50PEsBU(android.graphics.Paint paint, int i) {
        paint.setFilterBitmap(!FilterQuality.m2372equalsimpl0(i, FilterQuality.INSTANCE.m2379getNonefv9h1I()));
    }
