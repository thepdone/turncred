...
public final /* data */ class IntRect {
    ...
    public static /* synthetic */ void m4883getSizeYbymL2g$annotations() {
    }
    ...
    public final long m4891getSizeYbymL2g() {
    ...
    public final IntRect m4895translategyyYBs(long offset) {
        return new IntRect(this.left + IntOffset.m4865getXimpl(offset), this.top + IntOffset.m4866getYimpl(offset), this.right + IntOffset.m4865getXimpl(offset), this.bottom + IntOffset.m4866getYimpl(offset));
    }
