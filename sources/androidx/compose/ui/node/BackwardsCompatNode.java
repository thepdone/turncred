...
public final class BackwardsCompatNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, SemanticsModifierNode, PointerInputModifierNode, ModifierLocalModifierNode, ModifierLocalReadScope, ParentDataModifierNode, LayoutAwareModifierNode, GlobalPositionAwareModifierNode, FocusEventModifierNode, FocusPropertiesModifierNode, FocusRequesterModifierNode, OwnerScope, BuildDrawCacheParams {
    ...
    private final void unInitializeModifier() {
        ...
        if ((NodeKind.m3848constructorimpl(32) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((backwardsCompatNode.getKindSet() & NodeKind.m3848constructorimpl(8)) != 0) {
    ...
    private final void initializeModifier(boolean duringAttach) {
        ...
        if ((NodeKind.m3848constructorimpl(4) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m3848constructorimpl(2) & backwardsCompatNode.getKindSet()) != 0) {
        ...
        if ((NodeKind.m3848constructorimpl(128) & backwardsCompatNode.getKindSet()) != 0) {
                    ...
                    DelegatableNodeKt.requireOwner(this).registerOnLayoutCompletedListener(new Owner.OnLayoutCompletedListener() { // from class: androidx.compose.ui.node.BackwardsCompatNode.initializeModifier.3
                        ...
                        public void onLayoutComplete() {
                            if (BackwardsCompatNode.this.lastOnPlacedCoordinates == null) {
                                ...
                                backwardsCompatNode2.onPlaced(DelegatableNodeKt.m3735requireCoordinator64DMado(backwardsCompatNode2, NodeKind.m3848constructorimpl(128)));
                            }
                        }
                    });
                }
        ...
        if ((NodeKind.m3848constructorimpl(256) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof OnGloballyPositionedModifier) && BackwardsCompatNodeKt.isChainUpdate(this)) {
            DelegatableNodeKt.requireLayoutNode(this).invalidateMeasurements$ui_release();
        }
        if (element instanceof FocusRequesterModifier) {
            ((FocusRequesterModifier) element).getFocusRequester().getFocusRequesterNodes$ui_release().add(this);
        }
        if ((NodeKind.m3848constructorimpl(16) & backwardsCompatNode.getKindSet()) != 0 && (element instanceof PointerInputModifier)) {
            ((PointerInputModifier) element).getPointerInputFilter().setLayoutCoordinates$ui_release(getCoordinator());
        }
        if ((NodeKind.m3848constructorimpl(8) & backwardsCompatNode.getKindSet()) != 0) {
            DelegatableNodeKt.requireOwner(this).onSemanticsChange();
        }
    }
    ...
    public long mo1923getSizeNHjbRc() {
        return IntSizeKt.m4919toSizeozmzZPI(DelegatableNodeKt.m3735requireCoordinator64DMado(this, NodeKind.m3848constructorimpl(128)).mo3621getSizeYbymL2g());
    }
    ...
    public void mo530onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pass, long bounds) {
        ...
        ((PointerInputModifier) element).getPointerInputFilter().mo3508onPointerEventH0pRuoY(pointerEvent, pass, bounds);
    }
    ...
    public void mo684onRemeasuredozmzZPI(long size) {
        ...
        if (element instanceof OnRemeasuredModifier) {
            ((OnRemeasuredModifier) element).m3667onRemeasuredozmzZPI(size);
        }
    }
