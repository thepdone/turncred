...
public final class LayoutNodeLayoutDelegate {
    ...
    private final Function0<Unit> performMeasureBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performMeasureBlock$1
        ...
        public final void invoke2() {
            this.this$0.getOuterCoordinator().mo3613measureBRTryo0(this.this$0.performMeasureConstraints);
        }
    };
    ...
    public final Constraints m3781getLastConstraintsDWUhwKw() {
        return this.measurePassDelegate.m3789getLastConstraintsDWUhwKw();
    }

    /* renamed from: getLastLookaheadConstraints-DWUhwKw, reason: not valid java name */
    public final Constraints m3782getLastLookaheadConstraintsDWUhwKw() {
    ...
    public final class MeasurePassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        private long lastPosition = IntOffset.INSTANCE.m4875getZeronOccac();
        ...
        private long placeOuterCoordinatorPosition = IntOffset.INSTANCE.m4875getZeronOccac();
            ...
            this.placeOuterCoordinatorBlock = new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$MeasurePassDelegate$placeOuterCoordinatorBlock$1
                ...
                public final void invoke2() {
                    ...
                    if (graphicsLayer != null) {
                        placementScope2.m3692placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, graphicsLayer, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else if (function1 == null) {
                        placementScope2.m3683place70tqf50(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex);
                    } else {
                        placementScope2.m3691placeWithLayeraW9wM(layoutNodeLayoutDelegate.getOuterCoordinator(), measurePassDelegate.placeOuterCoordinatorPosition, measurePassDelegate.placeOuterCoordinatorZIndex, function1);
                    }
                }
            };
        }
        ...
        /* renamed from: getLastConstraints-DWUhwKw, reason: not valid java name */
        public final Constraints m3789getLastConstraintsDWUhwKw() {
            if (this.measuredOnce) {
                return Constraints.m4678boximpl(getMeasurementConstraints());
            }
            return null;
        }
        ...
        public Placeable mo3613measureBRTryo0(long constraints) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                lookaheadPassDelegate.mo3613measureBRTryo0(constraints);
            }
            trackMeasurementByParent(LayoutNodeLayoutDelegate.this.layoutNode);
            m3790remeasureBRTryo0(constraints);
            return this;
        }

        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m3790remeasureBRTryo0(long constraints) {
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getMeasurePending$ui_release() && Constraints.m4683equalsimpl0(getMeasurementConstraints(), constraints)) {
            ...
            long jMo3621getSizeYbymL2g = LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3621getSizeYbymL2g();
            m3676setMeasurementConstraintsBRTryo0(constraints);
            LayoutNodeLayoutDelegate.this.m3780performMeasureBRTryo0(constraints);
            if (IntSize.m4905equalsimpl0(LayoutNodeLayoutDelegate.this.getOuterCoordinator().mo3621getSizeYbymL2g(), jMo3621getSizeYbymL2g) && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth() == getWidth() && LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight() == getHeight()) {
                z = false;
            }
            m3675setMeasuredSizeozmzZPI(IntSizeKt.IntSize(LayoutNodeLayoutDelegate.this.getOuterCoordinator().getWidth(), LayoutNodeLayoutDelegate.this.getOuterCoordinator().getHeight()));
            return z;
        }
        ...
        public void mo3614placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m3788placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        public void mo3674placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m3788placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        private final void m3788placeSelfMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            Placeable.PlacementScope placementScope;
            this.isPlacedByParent = true;
            if (!IntOffset.m4864equalsimpl0(position, this.lastPosition) || this.needsCoordinatesUpdate) {
            ...
            if (LayoutNodeLayoutDelegateKt.isOutMostLookaheadRoot(LayoutNodeLayoutDelegate.this.layoutNode)) {
                ...
                Placeable.PlacementScope.place$default(placementScope2, lookaheadPassDelegate, IntOffset.m4865getXimpl(position), IntOffset.m4866getYimpl(position), 0.0f, 4, null);
            }
            ...
            m3787placeOuterCoordinatorMLgxB_4(position, zIndex, layerBlock, layer);
        }

        /* renamed from: placeOuterCoordinator-MLgxB_4, reason: not valid java name */
        private final void m3787placeOuterCoordinatorMLgxB_4(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLayoutPending() && getIsPlaced()) {
                LayoutNodeLayoutDelegate.this.getOuterCoordinator().m3838placeSelfApparentToRealOffsetMLgxB_4(position, zIndex, layerBlock, layer);
        ...
        public final void replace() {
            ...
            try {
                ...
                boolean isPlaced = getIsPlaced();
                m3787placeOuterCoordinatorMLgxB_4(this.lastPosition, this.lastZIndex, this.lastLayerBlock, this.lastExplicitLayer);
        ...
        private final void onBeforeLayoutChildren() {
            ...
            if (size > 0) {
                ...
                do {
                    LayoutNode layoutNode2 = content[i];
                    if (layoutNode2.getMeasurePending$ui_release() && layoutNode2.getMeasuredByParent$ui_release() == LayoutNode.UsageByParent.InMeasureBlock && LayoutNode.m3764remeasure_Sx5XlM$ui_release$default(layoutNode2, null, 1, null)) {
        ...
        public final void measureBasedOnLookahead() {
            ...
            if (lookaheadPassDelegate != null) {
                if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InMeasureBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.Measuring) {
                    ...
                    mo3613measureBRTryo0(lookaheadConstraints.getValue());
                    return;
                } else {
                    if (lookaheadPassDelegate.getMeasuredByParent() == LayoutNode.UsageByParent.InLayoutBlock && parent$ui_release.getLayoutState$ui_release() == LayoutNode.LayoutState.LayingOut) {
                        ...
                        mo3613measureBRTryo0(lookaheadConstraints2.getValue());
                        return;
                    }
                    return;
                }
        ...
        public final void placeBasedOnLookahead() {
            LookaheadPassDelegate lookaheadPassDelegate = LayoutNodeLayoutDelegate.this.getLookaheadPassDelegate();
            if (lookaheadPassDelegate != null) {
                m3788placeSelfMLgxB_4(lookaheadPassDelegate.getLastPosition(), lookaheadPassDelegate.getLastZIndex(), lookaheadPassDelegate.getLastLayerBlock$ui_release(), lookaheadPassDelegate.getLastExplicitLayer());
            } else {
                InlineClassHelperKt.throwIllegalStateExceptionForNullCheck("invalid lookaheadDelegate");
                throw new KotlinNothingValueException();
            }
    ...
    public final class LookaheadPassDelegate extends Placeable implements Measurable, AlignmentLinesOwner, MotionReferencePlacementDelegate {
        ...
        */
        public androidx.compose.ui.layout.Placeable mo3613measureBRTryo0(long r4) {
            /*
                r3 = this;
            ...
            L51:
                r3.m3786remeasureBRTryo0(r4)
                r4 = r3
                androidx.compose.ui.layout.Placeable r4 = (androidx.compose.ui.layout.Placeable) r4
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.compose.ui.node.LayoutNodeLayoutDelegate.LookaheadPassDelegate.mo3613measureBRTryo0(long):androidx.compose.ui.layout.Placeable");
        }
        ...
        /* renamed from: remeasure-BRTryo0, reason: not valid java name */
        public final boolean m3786remeasureBRTryo0(long constraints) {
            long jIntSize;
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("measure is called on a deactivated node");
            }
            ...
            if (!LayoutNodeLayoutDelegate.this.layoutNode.getLookaheadMeasurePending$ui_release()) {
                ...
                if (constraints2 == null ? false : Constraints.m4683equalsimpl0(constraints2.getValue(), constraints)) {
            ...
            this.lookaheadConstraints = Constraints.m4678boximpl(constraints);
            m3676setMeasurementConstraintsBRTryo0(constraints);
            getAlignmentLines().setUsedByModifierMeasurement$ui_release(false);
            ...
            LayoutNodeLayoutDelegate.this.m3779performLookaheadMeasureBRTryo0(constraints);
            m3675setMeasuredSizeozmzZPI(IntSizeKt.IntSize(lookaheadDelegate.getWidth(), lookaheadDelegate.getHeight()));
            return (IntSize.m4907getWidthimpl(jIntSize) == lookaheadDelegate.getWidth() && IntSize.m4906getHeightimpl(jIntSize) == lookaheadDelegate.getHeight()) ? false : true;
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo3614placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
            m3783placeSelfMLgxB_4(position, zIndex, layerBlock, null);
        }
        ...
        /* renamed from: placeAt-f8xVGno */
        public void mo3674placeAtf8xVGno(long position, float zIndex, GraphicsLayer layer) {
            m3783placeSelfMLgxB_4(position, zIndex, null, layer);
        }
        ...
        /* renamed from: placeSelf-MLgxB_4, reason: not valid java name */
        private final void m3783placeSelfMLgxB_4(final long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock, GraphicsLayer layer) {
            if (LayoutNodeLayoutDelegate.this.layoutNode.getIsDeactivated()) {
                InlineClassHelperKt.throwIllegalArgumentException("place is called on a deactivated node");
            }
            LayoutNodeLayoutDelegate.this.layoutState = LayoutNode.LayoutState.LookaheadLayingOut;
            this.placedOnce = true;
            this.onNodePlacedCalled = false;
            if (!IntOffset.m4864equalsimpl0(position, this.lastPosition)) {
            ...
            if (!LayoutNodeLayoutDelegate.this.getLookaheadLayoutPending() && getIsPlaced()) {
                LookaheadDelegate lookaheadDelegate = LayoutNodeLayoutDelegate.this.getOuterCoordinator().getLookaheadDelegate();
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.m3797placeSelfApparentToRealOffsetgyyYBs$ui_release(position);
                onNodePlaced$ui_release();
            } else {
                ...
                OwnerSnapshotObserver.observeLayoutModifierSnapshotReads$ui_release$default(snapshotObserver, layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$LookaheadPassDelegate$placeSelf$2
                    ...
                    public final void invoke2() {
                        ...
                        Placeable.PlacementScope.m3677place70tqf50$default(placementScope, lookaheadDelegate3, j, 0.0f, 2, null);
                    }
                }, 2, null);
            }
            this.lastPosition = position;
            ...
            if (size > 0) {
                ...
                do {
                    ...
                    if (layoutNode2.getLookaheadMeasurePending$ui_release() && layoutNode2.getMeasuredByParentInLookahead$ui_release() == LayoutNode.UsageByParent.InMeasureBlock) {
                        LookaheadPassDelegate lookaheadPassDelegate = layoutNode2.getLayoutDelegate().getLookaheadPassDelegate();
                        Intrinsics.checkNotNull(lookaheadPassDelegate);
                        Constraints constraintsM3782getLastLookaheadConstraintsDWUhwKw = layoutNode2.getLayoutDelegate().m3782getLastLookaheadConstraintsDWUhwKw();
                        Intrinsics.checkNotNull(constraintsM3782getLastLookaheadConstraintsDWUhwKw);
                        if (lookaheadPassDelegate.m3786remeasureBRTryo0(constraintsM3782getLastLookaheadConstraintsDWUhwKw.getValue())) {
        ...
        public final void replace() {
            ...
            try {
                ...
                this.onNodePlacedCalled = false;
                boolean isPlaced = getIsPlaced();
                m3783placeSelfMLgxB_4(this.lastPosition, 0.0f, this.lastLayerBlock, this.lastExplicitLayer);
                if (isPlaced && !this.onNodePlacedCalled && (parent$ui_release = LayoutNodeLayoutDelegate.this.layoutNode.getParent$ui_release()) != null) {
                    LayoutNode.requestLookaheadRelayout$ui_release$default(parent$ui_release, false, 1, null);
                }
            } finally {
    ...
    public final void m3780performMeasureBRTryo0(long constraints) {
    ...
    public final void m3779performLookaheadMeasureBRTryo0(final long constraints) {
        ...
        OwnerSnapshotObserver.observeMeasureSnapshotReads$ui_release$default(LayoutNodeKt.requireOwner(this.layoutNode).getSnapshotObserver(), this.layoutNode, false, new Function0<Unit>() { // from class: androidx.compose.ui.node.LayoutNodeLayoutDelegate$performLookaheadMeasure$1
            ...
            public final void invoke2() {
                ...
                Intrinsics.checkNotNull(lookaheadDelegate);
                lookaheadDelegate.mo3613measureBRTryo0(constraints);
            }
        }, 2, null);
