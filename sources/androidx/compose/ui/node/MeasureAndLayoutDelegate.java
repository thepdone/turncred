...
public final class MeasureAndLayoutDelegate {
    ...
    public final void m3803updateRootConstraintsBRTryo0(long constraints) {
        ...
        this.rootConstraints = Constraints.m4678boximpl(constraints);
    ...
    private final boolean m3800doLookaheadRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM3763lookaheadRemeasure_Sx5XlM$ui_release$default;
        if (layoutNode.getLookaheadRoot() == null) {
            return false;
        }
        if (constraints != null) {
            zM3763lookaheadRemeasure_Sx5XlM$ui_release$default = layoutNode.m3767lookaheadRemeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM3763lookaheadRemeasure_Sx5XlM$ui_release$default = LayoutNode.m3763lookaheadRemeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM3763lookaheadRemeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM3763lookaheadRemeasure_Sx5XlM$ui_release$default;
    }

    /* renamed from: doRemeasure-sdFAvZA, reason: not valid java name */
    private final boolean m3801doRemeasuresdFAvZA(LayoutNode layoutNode, Constraints constraints) {
        boolean zM3764remeasure_Sx5XlM$ui_release$default;
        if (constraints != null) {
            zM3764remeasure_Sx5XlM$ui_release$default = layoutNode.m3768remeasure_Sx5XlM$ui_release(constraints);
        } else {
            zM3764remeasure_Sx5XlM$ui_release$default = LayoutNode.m3764remeasure_Sx5XlM$ui_release$default(layoutNode, null, 1, null);
        }
        LayoutNode parent$ui_release = layoutNode.getParent$ui_release();
        if (zM3764remeasure_Sx5XlM$ui_release$default && parent$ui_release != null) {
        ...
        return zM3764remeasure_Sx5XlM$ui_release$default;
    }
    ...
    public final void m3802measureAndLayout0kLqBqw(LayoutNode layoutNode, long constraints) {
        if (layoutNode.getIsDeactivated()) {
            return;
        }
        ...
        if (this.rootConstraints != null) {
            ...
            try {
                ...
                if ((m3800doLookaheadRemeasuresdFAvZA(layoutNode, Constraints.m4678boximpl(constraints)) || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
                    layoutNode.lookaheadReplace$ui_release();
                }
                ensureSubtreeLookaheadReplaced(layoutNode);
                m3801doRemeasuresdFAvZA(layoutNode, Constraints.m4678boximpl(constraints));
    ...
    private final boolean remeasureAndRelayoutIfNeeded(LayoutNode layoutNode, boolean affectsLookahead, boolean relayoutNeeded) {
        ...
        if (layoutNode.isPlaced() || layoutNode.isPlacedByParent() || getCanAffectParent(layoutNode) || Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true) || getCanAffectParentInLookahead(layoutNode) || layoutNode.getAlignmentLinesRequired$ui_release()) {
            ...
            if (affectsLookahead) {
                zM3800doLookaheadRemeasuresdFAvZA = layoutNode.getLookaheadMeasurePending$ui_release() ? m3800doLookaheadRemeasuresdFAvZA(layoutNode, constraints) : false;
                if (relayoutNeeded && ((zM3800doLookaheadRemeasuresdFAvZA || layoutNode.getLookaheadLayoutPending$ui_release()) && Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true))) {
                    layoutNode.lookaheadReplace$ui_release();
                }
            } else {
                boolean zM3801doRemeasuresdFAvZA = layoutNode.getMeasurePending$ui_release() ? m3801doRemeasuresdFAvZA(layoutNode, constraints) : false;
                ...
                zM3800doLookaheadRemeasuresdFAvZA = zM3801doRemeasuresdFAvZA;
            }
            drainPostponedMeasureRequests();
        }
        return zM3800doLookaheadRemeasuresdFAvZA;
    }
    ...
    private final void remeasureOnly(LayoutNode layoutNode, boolean affectsLookahead) {
        ...
        if (affectsLookahead) {
            m3800doLookaheadRemeasuresdFAvZA(layoutNode, constraints);
        } else {
            m3801doRemeasuresdFAvZA(layoutNode, constraints);
        }
    }
