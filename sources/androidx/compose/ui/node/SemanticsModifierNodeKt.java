...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m3735requireCoordinator64DMado(node, NodeKind.m3848constructorimpl(8)));
        }
        return DelegatableNodeKt.m3735requireCoordinator64DMado(node, NodeKind.m3848constructorimpl(8)).touchBoundsInRoot();
    }
}
