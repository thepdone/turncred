...
public abstract class AlignmentLines {
    ...
    protected abstract long mo3720calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int initialPosition, NodeCoordinator initialCoordinator) {
        ...
        while (true) {
            jOffset = mo3720calculatePositionInParentR5De75A(initialCoordinator, jOffset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            fM2035getXimpl = Offset.m2036getYimpl(jOffset);
        } else {
            fM2035getXimpl = Offset.m2035getXimpl(jOffset);
        }
        int iRound = Math.round(fM2035getXimpl);
