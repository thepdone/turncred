...
public abstract class LookaheadDelegate extends LookaheadCapablePlaceable implements Measurable {
    ...
    public void m3799setPositiongyyYBs(long j) {
        this.position = j;
    }
    ...
    public final long m3795getSizeYbymL2g$ui_release() {
        return IntSizeKt.IntSize(getWidth(), getHeight());
    }

    /* renamed from: getConstraints-msEJaDk$ui_release, reason: not valid java name */
    public final long m3794getConstraintsmsEJaDk$ui_release() {
    ...
    public final void set_measureResult(MeasureResult measureResult) {
        ...
        if (measureResult != null) {
            m3675setMeasuredSizeozmzZPI(IntSizeKt.IntSize(measureResult.get$width(), measureResult.get$height()));
            unit = Unit.INSTANCE;
        } else {
            unit = null;
        }
        if (unit == null) {
            m3675setMeasuredSizeozmzZPI(IntSize.INSTANCE.m4912getZeroYbymL2g());
        }
    ...
    public void replace$ui_release() {
        mo3614placeAtf8xVGno(getPosition(), 0.0f, (Function1<? super GraphicsLayerScope, Unit>) null);
    }

    /* JADX INFO: Access modifiers changed from: protected */
    @Override // androidx.compose.ui.layout.Placeable
    /* renamed from: placeAt-f8xVGno */
    public final void mo3614placeAtf8xVGno(long position, float zIndex, Function1<? super GraphicsLayerScope, Unit> layerBlock) {
        m3793placeSelfgyyYBs(position);
    ...
    private final void m3793placeSelfgyyYBs(long position) {
        if (!IntOffset.m4864equalsimpl0(getPosition(), position)) {
            m3799setPositiongyyYBs(position);
    ...
    public final void m3797placeSelfApparentToRealOffsetgyyYBs$ui_release(long position) {
        m3793placeSelfgyyYBs(IntOffset.m4869plusqkQi6aY(position, getApparentToRealOffset()));
    }
    ...
    public final Placeable m3796performingMeasureK40F9xA(long constraints, Function0<? extends MeasureResult> block) {
    ...
    public final long m3798positionIniSbpLlY$ui_release(LookaheadDelegate ancestor, boolean excludingAgnosticOffset) {
        long jM4875getZeronOccac = IntOffset.INSTANCE.m4875getZeronOccac();
        ...
        while (!Intrinsics.areEqual(lookaheadDelegate, ancestor)) {
            if (!lookaheadDelegate.getIsPlacedUnderMotionFrameOfReference() || !excludingAgnosticOffset) {
                jM4875getZeronOccac = IntOffset.m4869plusqkQi6aY(jM4875getZeronOccac, lookaheadDelegate.getPosition());
            }
