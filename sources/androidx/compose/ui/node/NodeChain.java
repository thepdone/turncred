...
public final class NodeChain {
    ...
    public final void propagateCoordinator(Modifier.Node start, NodeCoordinator coordinator) {
        for (Modifier.Node parent = start.getParent(); parent != null; parent = parent.getParent()) {
            if (parent == NodeChainKt.SentinelHead) {
                ...
                if ((NodeKind.m3848constructorimpl(2) & parent.getKindSet()) != 0) {
                    return;
                }
    ...
    private final class Differ implements DiffCallback {
        ...
        public void remove(int atIndex, int oldIndex) {
            ...
            if ((NodeKind.m3848constructorimpl(2) & child.getKindSet()) != 0) {
                NodeCoordinator coordinator = child.getCoordinator();
                Intrinsics.checkNotNull(coordinator);
    ...
    public final boolean m3809hasH91voCI$ui_release(int type) {
    ...
    public final /* synthetic */ <T> T m3808firstFromHeadaLcG6gQ$ui_release(int type, Function1<? super T, Boolean> block) {
    ...
    public final /* synthetic */ <T> void m3811headToTailaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Modifier.Node nodePop = head;
    ...
    public final /* synthetic */ <T> void m3813tailToHeadaLcG6gQ$ui_release(int type, Function1<? super T, Unit> block) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
    ...
    public final /* synthetic */ <T> T m3812tailH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node tail = getTail(); tail != null; tail = tail.getParent()) {
                if ((tail.getKindSet() & type) != 0) {
                    Object obj = (T) tail;
    ...
    public final /* synthetic */ <T> T m3810headH91voCI$ui_release(int type) {
        if ((getAggregateChildKindSet() & type) != 0) {
            for (Modifier.Node head = getHead(); head != null; head = head.getChild()) {
                if ((head.getKindSet() & type) != 0) {
                    Object obj = (T) head;
