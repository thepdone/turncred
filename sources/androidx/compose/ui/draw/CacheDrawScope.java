...
public final class CacheDrawScope implements Density {
    ...
    public final long m1925getSizeNHjbRc() {
        return this.cacheParams.mo1923getSizeNHjbRc();
    }
    ...
    public static /* synthetic */ void m1924recordTdoYBX4$default(CacheDrawScope cacheDrawScope, GraphicsLayer graphicsLayer, Density density, LayoutDirection layoutDirection, long j, Function1 function1, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 4) != 0) {
            j = IntSizeKt.m4918toIntSizeuvyYCjk(cacheDrawScope.m1925getSizeNHjbRc());
        }
        cacheDrawScope.m1926recordTdoYBX4(graphicsLayer, density2, layoutDirection2, j, function1);
    }

    /* renamed from: record-TdoYBX4, reason: not valid java name */
    public final void m1926recordTdoYBX4(GraphicsLayer graphicsLayer, final Density density, final LayoutDirection layoutDirection, final long j, final Function1<? super ContentDrawScope, Unit> function1) {
        graphicsLayer.m2927recordmLhObY(density, layoutDirection, j, new Function1<DrawScope, Unit>() { // from class: androidx.compose.ui.draw.CacheDrawScope$record$1
            ...
            public final void invoke2(DrawScope drawScope) {
                ...
                long jSize = SizeKt.Size(IntSize.m4907getWidthimpl(j2), IntSize.m4906getHeightimpl(j2));
                ...
                drawContext.mo2755setSizeuvyYCjk(jSize);
