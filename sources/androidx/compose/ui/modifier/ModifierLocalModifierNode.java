...
public interface ModifierLocalModifierNode extends ModifierLocalReadScope, DelegatableNode {
    ...
    default <T> void provide(ModifierLocal<T> key, T value) {
        ...
        getProvidedValues().mo3719set$ui_release(key, value);
    }
