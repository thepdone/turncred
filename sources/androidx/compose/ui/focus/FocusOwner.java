...
public interface FocusOwner extends FocusManager {
    ...
    boolean mo1964clearFocusI7lrPNg(boolean force, boolean refreshFocusEvents, boolean clearOwnerFocus, int focusDirection);

    /* renamed from: dispatchInterceptedSoftKeyboardEvent-ZmokQxo, reason: not valid java name */
    boolean mo1965dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w, reason: not valid java name */
    boolean mo1966dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> onFocusedItem);

    boolean dispatchRotaryEvent(RotaryScrollEvent event);

    /* renamed from: focusSearch-ULY8qGw, reason: not valid java name */
    Boolean mo1967focusSearchULY8qGw(int focusDirection, Rect focusedRect, Function1<? super FocusTargetNode, Boolean> onFound);
    ...
    boolean mo1968requestFocusForOwner7o62pno(FocusDirection focusDirection, Rect previouslyFocusedRect);
    ...
    boolean mo1969takeFocusaToIllA(int focusDirection, Rect previouslyFocusedRect);

    /* JADX WARN: Multi-variable type inference failed */
    /* renamed from: dispatchKeyEvent-YhN2O0w$default, reason: not valid java name */
    static /* synthetic */ boolean m1963dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj != null) {
        ...
        return focusOwner.mo1966dispatchKeyEventYhN2O0w(keyEvent, function0);
    }
}
