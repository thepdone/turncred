...
public final class RenderNodeApi29 implements DeviceRenderNode {
    ...
    private int internalCompositingStrategy = CompositingStrategy.INSTANCE.m2366getAutoNrFUSI();
    ...
    public void mo3964setCompositingStrategyaDBOjCE(int i) {
        RenderNode renderNode = this.renderNode;
        if (CompositingStrategy.m2362equalsimpl0(i, CompositingStrategy.INSTANCE.m2368getOffscreenNrFUSI())) {
            renderNode.setUseCompositingLayer(true, null);
            renderNode.setHasOverlappingRendering(true);
        } else if (CompositingStrategy.m2362equalsimpl0(i, CompositingStrategy.INSTANCE.m2367getModulateAlphaNrFUSI())) {
    ...
    public void record(CanvasHolder canvasHolder, Path clipPath, Function1<? super Canvas, Unit> drawBlock) {
        ...
        if (clipPath != null) {
            androidCanvas.save();
            Canvas.m2247clipPathmtrdDE$default(androidCanvas, clipPath, 0, 2, null);
        }
