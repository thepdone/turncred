    ...
    private static final boolean calculateIfHorizontallyStacked(List<SemanticsNode> list) {
        ...
        if (list.size() == 0 || list.size() == 1) {
            ...
            while (i < lastIndex) {
                ...
                arrayListEmptyList.add(Offset.m2024boximpl(OffsetKt.Offset(Math.abs(Offset.m2035getXimpl(semanticsNode4.getBoundsInRoot().m2065getCenterF1C5BW0()) - Offset.m2035getXimpl(semanticsNode3.getBoundsInRoot().m2065getCenterF1C5BW0())), Math.abs(Offset.m2036getYimpl(semanticsNode4.getBoundsInRoot().m2065getCenterF1C5BW0()) - Offset.m2036getYimpl(semanticsNode3.getBoundsInRoot().m2065getCenterF1C5BW0())))));
        ...
        if (arrayListEmptyList.size() == 1) {
            ...
            if (1 <= lastIndex2) {
                int i2 = 1;
                while (true) {
                    objFirst = Offset.m2024boximpl(Offset.m2040plusMKHz9U(((Offset) objFirst).getPackedValue(), ((Offset) arrayListEmptyList.get(i2)).getPackedValue()));
                    if (i2 == lastIndex2) {
                        break;
                    }
                    i2++;
        ...
        return Offset.m2036getYimpl(packedValue) < Offset.m2035getXimpl(packedValue);
    }
