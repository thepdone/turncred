...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        ...
        this.currentPointerPositionAccumulator = Offset.INSTANCE.m2051getZeroF1C5BW0();
    }
    ...
    public final void m3586setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m3582addPositionUv8p0NA(long timeMillis, long position) {
        this.xVelocityTracker.addDataPoint(timeMillis, Offset.m2035getXimpl(position));
        this.yVelocityTracker.addDataPoint(timeMillis, Offset.m2036getYimpl(position));
    }

    /* renamed from: calculateVelocity-9UxMQ8M, reason: not valid java name */
    public final long m3583calculateVelocity9UxMQ8M() {
        return m3584calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc, reason: not valid java name */
    public final long m3584calculateVelocityAH228Gc(long maximumVelocity) {
        if (!(Velocity.m4974getXimpl(maximumVelocity) > 0.0f && Velocity.m4975getYimpl(maximumVelocity) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + ((Object) Velocity.m4981toStringimpl(maximumVelocity)));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m4974getXimpl(maximumVelocity)), this.yVelocityTracker.calculateVelocity(Velocity.m4975getYimpl(maximumVelocity)));
    }
