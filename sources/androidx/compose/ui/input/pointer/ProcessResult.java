...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m3568boximpl(int i) {
    ...
    public static final boolean m3572getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl, reason: not valid java name */
    public static final boolean m3573getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }

    /* renamed from: hashCode-impl, reason: not valid java name */
    public static int m3574hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl, reason: not valid java name */
    public static String m3575toStringimpl(int i) {
    ...
    public int hashCode() {
        return m3574hashCodeimpl(this.value);
    }
