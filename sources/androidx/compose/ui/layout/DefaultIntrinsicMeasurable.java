...
public final class DefaultIntrinsicMeasurable implements Measurable {
    ...
    public Placeable mo3613measureBRTryo0(long constraints) {
        ...
        if (intrinsicWidthHeight == intrinsicWidthHeight2) {
            ...
            return new FixedSizeIntrinsicsPlaceable(iMinIntrinsicWidth, iM4690getMaxWidthimpl);
        }
        if (this.minMax == IntrinsicMinMax.Max) {
        ...
        return new FixedSizeIntrinsicsPlaceable(iM4690getMaxWidthimpl, iMinIntrinsicHeight);
    }
