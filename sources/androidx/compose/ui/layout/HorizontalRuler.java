...
public final class HorizontalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float coordinate, LayoutCoordinates sourceCoordinates, LayoutCoordinates targetCoordinates) {
        return Offset.m2036getYimpl(targetCoordinates.mo3622localPositionOfR5De75A(sourceCoordinates, OffsetKt.Offset(IntSize.m4907getWidthimpl(sourceCoordinates.mo3621getSizeYbymL2g()) / 2.0f, coordinate)));
    }
}
