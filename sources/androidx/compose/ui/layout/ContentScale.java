...
public interface ContentScale {
    ...
    long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize);
    ...
    public static final class Companion {
        ...
        private static final ContentScale Crop = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Crop$1
            ...
            public long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3610computeFillMaxDimensioniLBOSCw = ContentScaleKt.m3610computeFillMaxDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3610computeFillMaxDimensioniLBOSCw, fM3610computeFillMaxDimensioniLBOSCw);
            }
        };
        private static final ContentScale Fit = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Fit$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3611computeFillMinDimensioniLBOSCw = ContentScaleKt.m3611computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3611computeFillMinDimensioniLBOSCw, fM3611computeFillMinDimensioniLBOSCw);
            }
        };
        private static final ContentScale FillHeight = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillHeight$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3609computeFillHeightiLBOSCw = ContentScaleKt.m3609computeFillHeightiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3609computeFillHeightiLBOSCw, fM3609computeFillHeightiLBOSCw);
            }
        };
        private static final ContentScale FillWidth = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillWidth$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                float fM3612computeFillWidthiLBOSCw = ContentScaleKt.m3612computeFillWidthiLBOSCw(srcSize, dstSize);
                return ScaleFactorKt.ScaleFactor(fM3612computeFillWidthiLBOSCw, fM3612computeFillWidthiLBOSCw);
            }
        };
        private static final ContentScale Inside = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$Inside$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                if (Size.m2104getWidthimpl(srcSize) > Size.m2104getWidthimpl(dstSize) || Size.m2101getHeightimpl(srcSize) > Size.m2101getHeightimpl(dstSize)) {
                    float fM3611computeFillMinDimensioniLBOSCw = ContentScaleKt.m3611computeFillMinDimensioniLBOSCw(srcSize, dstSize);
                    return ScaleFactorKt.ScaleFactor(fM3611computeFillMinDimensioniLBOSCw, fM3611computeFillMinDimensioniLBOSCw);
                }
        ...
        private static final ContentScale FillBounds = new ContentScale() { // from class: androidx.compose.ui.layout.ContentScale$Companion$FillBounds$1
            ...
            /* renamed from: computeScaleFactor-H7hwNQA */
            public long mo3604computeScaleFactorH7hwNQA(long srcSize, long dstSize) {
                return ScaleFactorKt.ScaleFactor(ContentScaleKt.m3612computeFillWidthiLBOSCw(srcSize, dstSize), ContentScaleKt.m3609computeFillHeightiLBOSCw(srcSize, dstSize));
            }
        };
