...
public final class SubcomposeLayoutKt {
    ...
    public static final void SubcomposeLayout(final SubcomposeLayoutState subcomposeLayoutState, Modifier modifier, final Function2<? super SubcomposeMeasureScope, ? super Constraints, ? extends MeasureResult> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 147) != 146 || !composerStartRestartGroup.getSkipping()) {
            ...
            Updater.m1776setimpl(composerM1769constructorimpl, subcomposeLayoutState, subcomposeLayoutState.getSetRoot$ui_release());
            Updater.m1776setimpl(composerM1769constructorimpl, compositionContextRememberCompositionContext, subcomposeLayoutState.getSetCompositionContext$ui_release());
            Updater.m1776setimpl(composerM1769constructorimpl, function2, subcomposeLayoutState.getSetMeasurePolicy$ui_release());
