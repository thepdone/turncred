...
public final class EditProcessor {
    ...
    private TextFieldValue mBufferState = new TextFieldValue(AnnotatedStringKt.emptyAnnotatedString(), TextRange.INSTANCE.m4227getZerod9O1mEE(), (TextRange) null, (DefaultConstructorMarker) null);
    ...
    public final void reset(TextFieldValue value, TextInputSession textInputSession) {
        boolean zAreEqual = Intrinsics.areEqual(value.getComposition(), this.mBuffer.m4381getCompositionMzsxiRA$ui_text_release());
        boolean z = true;
        boolean z2 = false;
        ...
        } else if (TextRange.m4215equalsimpl0(this.mBufferState.getSelection(), value.getSelection())) {
            z = false;
        } else {
            this.mBuffer.setSelection$ui_text_release(TextRange.m4220getMinimpl(value.getSelection()), TextRange.m4219getMaximpl(value.getSelection()));
            z2 = true;
            z = false;
        }
        if (value.getComposition() == null) {
            this.mBuffer.commitComposition$ui_text_release();
        } else if (!TextRange.m4216getCollapsedimpl(value.getComposition().getPackedValue())) {
            this.mBuffer.setComposition$ui_text_release(TextRange.m4220getMinimpl(value.getComposition().getPackedValue()), TextRange.m4219getMaximpl(value.getComposition().getPackedValue()));
        }
        if (z || (!z2 && !zAreEqual)) {
            this.mBuffer.commitComposition$ui_text_release();
            value = TextFieldValue.m4464copy3r_uNRQ$default(value, (AnnotatedString) null, 0L, (TextRange) null, 3, (Object) null);
        }
    ...
    private final String generateBatchErrorMessage(List<? extends EditCommand> editCommands, final EditCommand failedCommand) {
        ...
        StringBuilder sbAppend = sb.append("Error while applying EditCommand batch to buffer (length=" + this.mBuffer.getLength$ui_text_release() + ", composition=" + this.mBuffer.m4381getCompositionMzsxiRA$ui_text_release() + ", selection=" + ((Object) TextRange.m4225toStringimpl(this.mBuffer.m4382getSelectiond9O1mEE$ui_text_release())) + "):");
        Intrinsics.checkNotNullExpressionValue(sbAppend, "append(value)");
        Intrinsics.checkNotNullExpressionValue(sbAppend.append('\n'), "append('\\n')");
        CollectionsKt.joinTo(editCommands, sb, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 2) != 0 ? ", " : "\n", (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 4) != 0 ? "" : null, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 8) != 0 ? "" : null, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 16) != 0 ? -1 : 0, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 32) != 0 ? "..." : null, (OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS & 64) != 0 ? null : new Function1<EditCommand, CharSequence>() { // from class: androidx.compose.ui.text.input.EditProcessor$generateBatchErrorMessage$1$1
    ...
    public final TextFieldValue apply(List<? extends EditCommand> editCommands) {
        ...
        try {
            ...
            long jM4382getSelectiond9O1mEE$ui_text_release = this.mBuffer.m4382getSelectiond9O1mEE$ui_text_release();
            TextRange textRangeM4210boximpl = TextRange.m4210boximpl(jM4382getSelectiond9O1mEE$ui_text_release);
            textRangeM4210boximpl.getPackedValue();
            TextRange textRange = TextRange.m4221getReversedimpl(this.mBufferState.getSelection()) ? null : textRangeM4210boximpl;
            TextFieldValue textFieldValue = new TextFieldValue(annotatedString$ui_text_release, textRange != null ? textRange.getPackedValue() : TextRangeKt.TextRange(TextRange.m4219getMaximpl(jM4382getSelectiond9O1mEE$ui_text_release), TextRange.m4220getMinimpl(jM4382getSelectiond9O1mEE$ui_text_release)), this.mBuffer.m4381getCompositionMzsxiRA$ui_text_release(), (DefaultConstructorMarker) null);
