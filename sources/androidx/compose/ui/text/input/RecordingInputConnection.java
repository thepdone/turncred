...
public final class RecordingInputConnection implements InputConnection {
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4216getCollapsedimpl(this.mTextFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m4220getMinimpl(this.mTextFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        ...
        this.eventCallback.mo4419onImeActionKlQnJC8(iM4400getDefaulteUduSuo);
        return true;
    }
