...
public final /* data */ class ParagraphInfo {
    ...
    public final long m4103toLocalMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m2035getXimpl(j), Offset.m2036getYimpl(j) - this.top);
    }

    public final Rect toGlobal(Rect rect) {
        return rect.m2072translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
    }
    ...
    public final Path toGlobal(Path path) {
        path.mo2171translatek4lQ0M(OffsetKt.Offset(0.0f, this.top));
        return path;
    }

    /* renamed from: toGlobal-xdX6-G0$default, reason: not valid java name */
    public static /* synthetic */ long m4101toGlobalxdX6G0$default(ParagraphInfo paragraphInfo, long j, boolean z, int i, Object obj) {
        if ((i & 1) != 0) {
            z = true;
        }
        return paragraphInfo.m4102toGlobalxdX6G0(j, z);
    }

    /* renamed from: toGlobal-xdX6-G0, reason: not valid java name */
    public final long m4102toGlobalxdX6G0(long j, boolean z) {
        if (z && TextRange.m4215equalsimpl0(j, TextRange.INSTANCE.m4227getZerod9O1mEE())) {
            return TextRange.INSTANCE.m4227getZerod9O1mEE();
        }
        return TextRangeKt.TextRange(toGlobalIndex(TextRange.m4222getStartimpl(j)), toGlobalIndex(TextRange.m4217getEndimpl(j)));
    }
}
