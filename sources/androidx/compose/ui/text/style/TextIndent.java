...
public final class TextIndent {
    ...
    public static /* synthetic */ TextIndent m4648copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m4649copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo, reason: not valid java name */
    public final TextIndent m4649copyNB67dxo(long firstLine, long restLine) {
    ...
    public boolean equals(Object other) {
        ...
        return TextUnit.m4927equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m4927equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m4931hashCodeimpl(this.firstLine) * 31) + TextUnit.m4931hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + ((Object) TextUnit.m4937toStringimpl(this.firstLine)) + ", restLine=" + ((Object) TextUnit.m4937toStringimpl(this.restLine)) + ')';
    }
}
