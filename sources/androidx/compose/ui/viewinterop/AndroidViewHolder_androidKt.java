...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int iRound = Math.round(Offset.m2035getXimpl(jPositionInRoot));
        int iRound2 = Math.round(Offset.m2036getYimpl(jPositionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.INSTANCE.m3379getUserInputWNlRxjI();
        }
        return NestedScrollSource.INSTANCE.m3378getSideEffectWNlRxjI();
    }
}
