...
final /* data */ class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult mo385measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        final Placeable placeableMo3613measureBRTryo0 = measurable.mo3613measureBRTryo0(measurable.maxIntrinsicWidth(Constraints.m4689getMaxHeightimpl(j)) < Constraints.m4690getMaxWidthimpl(j) ? j : Constraints.m4681copyZbe2FdA$default(j, 0, Integer.MAX_VALUE, 0, 0, 13, null));
        final int iMin = Math.min(placeableMo3613measureBRTryo0.getWidth(), Constraints.m4690getMaxWidthimpl(j));
        return MeasureScope.layout$default(measureScope, iMin, placeableMo3613measureBRTryo0.getHeight(), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.HorizontalScrollLayoutModifier$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                this.getScrollerPosition().update(Orientation.Horizontal, TextFieldScrollKt.getCursorRectInScroller(measureScope2, cursorOffset, transformedText, textLayoutResultProxyInvoke != null ? textLayoutResultProxyInvoke.getValue() : null, measureScope.getLayoutDirection() == LayoutDirection.Rtl, placeableMo3613measureBRTryo0.getWidth()), iMin, placeableMo3613measureBRTryo0.getWidth());
                Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo3613measureBRTryo0, Math.round(-this.getScrollerPosition().getOffset()), 0, 0.0f, 4, null);
            }
        }, 4, null);
    }
}
