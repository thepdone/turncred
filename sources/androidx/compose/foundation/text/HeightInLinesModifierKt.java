        ...
        return ComposedModifierKt.composed(modifier, InspectableValueKt.isDebugInspectorInfoEnabled() ? new Function1<InspectorInfo, Unit>() { // from class: androidx.compose.foundation.text.HeightInLinesModifierKt$heightInLines$$inlined$debugInspectorInfo$1
            ...
            public final Modifier invoke(Modifier modifier2, Composer composer, int i3) {
                ...
                if (zChanged2 || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                    ...
                    FontStyle fontStyleM4254getFontStyle4Lr2A7w = textStyle3.m4254getFontStyle4Lr2A7w();
                    int iM4335unboximpl = fontStyleM4254getFontStyle4Lr2A7w != null ? fontStyleM4254getFontStyle4Lr2A7w.m4335unboximpl() : FontStyle.INSTANCE.m4339getNormal_LCdwA();
                    FontSynthesis fontSynthesisM4255getFontSynthesisZQGJjVo = textStyle3.m4255getFontSynthesisZQGJjVo();
                    objRememberedValue2 = resolver.mo4307resolveDPcqOEQ(fontFamily, fontWeight, iM4335unboximpl, fontSynthesisM4255getFontSynthesisZQGJjVo != null ? fontSynthesisM4255getFontSynthesisZQGJjVo.getValue() : FontSynthesis.INSTANCE.m4349getAllGVVA2EU());
                ...
                if (zChanged3 || objRememberedValue3 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue3 = Integer.valueOf(IntSize.m4906getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement(), 1)));
                ...
                if (zChanged4 || objRememberedValue4 == Composer.INSTANCE.getEmpty()) {
                    objRememberedValue4 = Integer.valueOf(IntSize.m4906getHeightimpl(TextFieldDelegateKt.computeSizeForDefaultText(textStyle3, density, resolver, TextFieldDelegateKt.getEmptyTextReplacement() + '\n' + TextFieldDelegateKt.getEmptyTextReplacement(), 2)));
                ...
                Modifier modifierM1034heightInVpY3zN4 = SizeKt.m1034heightInVpY3zN4(Modifier.INSTANCE, numValueOf != null ? density.mo691toDpu2uoSUM(numValueOf.intValue()) : Dp.INSTANCE.m4757getUnspecifiedD9Ej5fM(), numValueOf2 != null ? density.mo691toDpu2uoSUM(numValueOf2.intValue()) : Dp.INSTANCE.m4757getUnspecifiedD9Ej5fM());
                if (ComposerKt.isTraceInProgress()) {
                    ComposerKt.traceEventEnd();
                }
                composer.endReplaceGroup();
