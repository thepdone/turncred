...
public final class TextFieldScrollerPosition {
    ...
    public TextFieldScrollerPosition(Orientation orientation, float f) {
        ...
        this.previousSelection = TextRange.INSTANCE.m4227getZerod9O1mEE();
    ...
    public final int m1403getOffsetToFollow5zctL8(long selection) {
        return TextRange.m4222getStartimpl(selection) != TextRange.m4222getStartimpl(this.previousSelection) ? TextRange.m4222getStartimpl(selection) : TextRange.m4217getEndimpl(selection) != TextRange.m4217getEndimpl(this.previousSelection) ? TextRange.m4217getEndimpl(selection) : TextRange.m4220getMinimpl(selection);
    }
