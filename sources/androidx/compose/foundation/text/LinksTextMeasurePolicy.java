...
final class LinksTextMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult mo359measure3p2s80s(MeasureScope measureScope, final List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m4690getMaxWidthimpl(j), Constraints.m4689getMaxHeightimpl(j), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.text.LinksTextMeasurePolicy$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                ...
                if (listMeasureWithTextRangeMeasureConstraints != null) {
                    ...
                    for (int i = 0; i < size; i++) {
                        ...
                        Placeable.PlacementScope.m3677place70tqf50$default(placementScope, placeable, function0 != null ? ((IntOffset) function0.invoke()).getPackedValue() : IntOffset.INSTANCE.m4875getZeronOccac(), 0.0f, 2, null);
                    }
                }
            }
        }, 4, null);
