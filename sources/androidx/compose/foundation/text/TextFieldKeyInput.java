...
public final class TextFieldKeyInput {
    ...
    private final CommitTextCommand m1395typedCommandZmokQxo(KeyEvent event) {
        Integer numM1316consumeZmokQxo;
        if (TextFieldKeyInput_androidKt.m1400isTypedEventZmokQxo(event) && (numM1316consumeZmokQxo = this.keyCombiner.m1316consumeZmokQxo(event)) != null) {
    ...
    public final boolean m1396processZmokQxo(KeyEvent event) {
        final KeyCommand keyCommandMo1318mapZmokQxo;
        CommitTextCommand commitTextCommandM1395typedCommandZmokQxo = m1395typedCommandZmokQxo(event);
        ...
        if (!KeyEventType.m3335equalsimpl0(KeyEvent_androidKt.m3343getTypeZmokQxo(event), KeyEventType.INSTANCE.m3339getKeyDownCS__XNY()) || (keyCommandMo1318mapZmokQxo = this.keyMapping.mo1318mapZmokQxo(event)) == null || (keyCommandMo1318mapZmokQxo.getEditsText() && !this.editable)) {
            return false;
        }
                ...
                switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo1318mapZmokQxo.ordinal()]) {
                    ...
                    case 20:
                        List<EditCommand> listDeleteIfSelectedOr = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.3
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                return new DeleteSurroundingTextCommand(TextRange.m4217getEndimpl(textFieldPreparedSelection2.getSelection()) - textFieldPreparedSelection2.getPrecedingCharacterIndex(), 0);
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr2 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.4
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (nextCharacterIndex != -1) {
                                    return new DeleteSurroundingTextCommand(0, nextCharacterIndex - TextRange.m4217getEndimpl(textFieldPreparedSelection2.getSelection()));
                                }
                                return null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr3 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.5
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (previousWordOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4217getEndimpl(textFieldPreparedSelection2.getSelection()) - previousWordOffset.intValue(), 0);
                                } else {
                    ...
                    case 23:
                        List<EditCommand> listDeleteIfSelectedOr4 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.6
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return nextWordOffset != null ? new DeleteSurroundingTextCommand(0, nextWordOffset.intValue() - TextRange.m4217getEndimpl(textFieldPreparedSelection2.getSelection())) : null;
                            }
                        });
                        ...
                        List<EditCommand> listDeleteIfSelectedOr5 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.7
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                if (lineStartByOffset != null) {
                                    deleteSurroundingTextCommand = new DeleteSurroundingTextCommand(TextRange.m4217getEndimpl(textFieldPreparedSelection2.getSelection()) - lineStartByOffset.intValue(), 0);
                                } else {
                                    deleteSurroundingTextCommand = null;
                                }
                                return deleteSurroundingTextCommand;
                    ...
                    case 25:
                        List<EditCommand> listDeleteIfSelectedOr6 = textFieldPreparedSelection.deleteIfSelectedOr(new Function1<TextFieldPreparedSelection, EditCommand>() { // from class: androidx.compose.foundation.text.TextFieldKeyInput$process$2.8
                            ...
                            public final EditCommand invoke(TextFieldPreparedSelection textFieldPreparedSelection2) {
                                ...
                                return lineEndByOffset != null ? new DeleteSurroundingTextCommand(0, lineEndByOffset.intValue() - TextRange.m4217getEndimpl(textFieldPreparedSelection2.getSelection())) : null;
                            }
                        });
                    ...
                    case 26:
                        if (!this.getSingleLine()) {
                            ...
                            this.getState().getOnImeActionPerformed().invoke(ImeAction.m4384boximpl(this.imeAction));
                            break;
                        }
                    case 27:
                        if (!this.getSingleLine()) {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        if (TextRange.m4215equalsimpl0(textFieldPreparedSelection.getSelection(), this.value.getSelection()) && Intrinsics.areEqual(textFieldPreparedSelection.getAnnotatedString(), this.value.getAnnotatedString())) {
            return;
        }
