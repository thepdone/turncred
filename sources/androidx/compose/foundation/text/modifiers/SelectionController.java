...
public final class SelectionController implements RememberObserver {
    ...
    public final void draw(DrawScope drawScope) {
        ...
        if (!this.params.getShouldClip()) {
            DrawScope.m2823drawPathLG529CI$default(drawScope, pathForRange, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
            return;
        }
        float fM2104getWidthimpl = Size.m2104getWidthimpl(drawScope.mo2833getSizeNHjbRc());
        float fM2101getHeightimpl = Size.m2101getHeightimpl(drawScope.mo2833getSizeNHjbRc());
        ...
        try {
            drawContext.getTransform().mo2757clipRectN_I0leg(0.0f, 0.0f, fM2104getWidthimpl, fM2101getHeightimpl, iM2265getIntersectrtfAjoo);
            DrawScope.m2823drawPathLG529CI$default(drawScope, pathForRange, this.backgroundSelectionColor, 0.0f, null, null, 0, 60, null);
        } finally {
