...
public final class ParagraphLayoutCache {
    ...
    private ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3) {
        ...
        this.prevConstraints = Constraints.INSTANCE.m4700fixedJhjzzOo(0, 0);
    ...
    public /* synthetic */ ParagraphLayoutCache(String str, TextStyle textStyle, FontFamily.Resolver resolver, int i, boolean z, int i2, int i3, int i4, DefaultConstructorMarker defaultConstructorMarker) {
        this(str, textStyle, resolver, (i4 & 8) != 0 ? TextOverflow.INSTANCE.m4675getClipgIe3tQ8() : i, (i4 & 16) != 0 ? true : z, (i4 & 32) != 0 ? Integer.MAX_VALUE : i2, (i4 & 64) != 0 ? 1 : i3, null);
    }
    ...
    public final boolean m1634layoutWithConstraintsK40F9xA(long constraints, LayoutDirection layoutDirection) {
        boolean z = true;
        if (this.minLines > 1) {
            ...
            constraints = minLinesConstrainerFrom.m1623coerceMinLinesOh53vG4$foundation_release(constraints, this.minLines);
        }
        boolean z2 = false;
        if (!m1632newLayoutWillBeDifferentK40F9xA(constraints, layoutDirection)) {
            if (!Constraints.m4683equalsimpl0(constraints, this.prevConstraints)) {
                Paragraph paragraph = this.paragraph;
                Intrinsics.checkNotNull(paragraph);
                this.layoutSize = ConstraintsKt.m4704constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(Math.min(paragraph.getMaxIntrinsicWidth(), paragraph.getWidth())), TextDelegateKt.ceilToIntPx(paragraph.getHeight())));
                if (TextOverflow.m4668equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4677getVisiblegIe3tQ8()) || (IntSize.m4907getWidthimpl(r3) >= paragraph.getWidth() && IntSize.m4906getHeightimpl(r3) >= paragraph.getHeight())) {
                    z = false;
                }
                this.didOverflow = z;
        ...
        Paragraph paragraphM1631layoutTextK40F9xA = m1631layoutTextK40F9xA(constraints, layoutDirection);
        this.prevConstraints = constraints;
        this.layoutSize = ConstraintsKt.m4704constrain4WqzIAM(constraints, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(paragraphM1631layoutTextK40F9xA.getWidth()), TextDelegateKt.ceilToIntPx(paragraphM1631layoutTextK40F9xA.getHeight())));
        if (!TextOverflow.m4668equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4677getVisiblegIe3tQ8()) && (IntSize.m4907getWidthimpl(r9) < paragraphM1631layoutTextK40F9xA.getWidth() || IntSize.m4906getHeightimpl(r9) < paragraphM1631layoutTextK40F9xA.getHeight())) {
            z2 = true;
        }
        this.didOverflow = z2;
    ...
    public final int intrinsicHeight(int width, LayoutDirection layoutDirection) {
        ...
        int iCeilToIntPx = TextDelegateKt.ceilToIntPx(m1631layoutTextK40F9xA(ConstraintsKt.Constraints(0, width, 0, Integer.MAX_VALUE), layoutDirection).getHeight());
    ...
    public final void m1636updateL6sJoHM(String text, TextStyle style, FontFamily.Resolver fontFamilyResolver, int overflow, boolean softWrap, int maxLines, int minLines) {
        this.text = text;
        this.style = style;
    ...
    private final Paragraph m1631layoutTextK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ParagraphIntrinsics layoutDirection2 = setLayoutDirection(layoutDirection);
        return ParagraphKt.m4106Paragraph_EkL_Y(layoutDirection2, LayoutUtilsKt.m1620finalConstraintstfFHcEY(constraints, this.softWrap, this.overflow, layoutDirection2.getMaxIntrinsicWidth()), LayoutUtilsKt.m1621finalMaxLinesxdlQI24(this.softWrap, this.overflow, this.maxLines), TextOverflow.m4668equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4676getEllipsisgIe3tQ8()));
    }

    /* renamed from: newLayoutWillBeDifferent-K40F9xA, reason: not valid java name */
    private final boolean m1632newLayoutWillBeDifferentK40F9xA(long constraints, LayoutDirection layoutDirection) {
        ...
        return Constraints.m4690getMaxWidthimpl(constraints) != Constraints.m4690getMaxWidthimpl(this.prevConstraints) || ((float) Constraints.m4689getMaxHeightimpl(constraints)) < paragraph.getHeight() || paragraph.getDidExceedMaxLines();
    }
    ...
    public final TextLayoutResult slowCreateTextLayoutResultOrNull(TextStyle style) {
        ...
        long jM4681copyZbe2FdA$default = Constraints.m4681copyZbe2FdA$default(this.prevConstraints, 0, 0, 0, 0, 10, null);
        return new TextLayoutResult(new TextLayoutInput(annotatedString, style, CollectionsKt.emptyList(), this.maxLines, this.softWrap, this.overflow, density, layoutDirection, this.fontFamilyResolver, jM4681copyZbe2FdA$default, (DefaultConstructorMarker) null), new MultiParagraph(new MultiParagraphIntrinsics(annotatedString, style, (List<AnnotatedString.Range<Placeholder>>) CollectionsKt.emptyList(), density, this.fontFamilyResolver), jM4681copyZbe2FdA$default, this.maxLines, TextOverflow.m4668equalsimpl0(this.overflow, TextOverflow.INSTANCE.m4676getEllipsisgIe3tQ8()), null), this.layoutSize, null);
    }
    ...
    public String toString() {
        return "ParagraphLayoutCache(paragraph=" + (this.paragraph != null ? "<paragraph>" : "null") + ", lastDensity=" + ((Object) InlineDensity.m1617toStringimpl(this.lastDensity)) + ')';
    }
}
