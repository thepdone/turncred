...
public final class TextFieldSelectionManager_androidKt {
    ...
    public static final Modifier textFieldMagnifier(Modifier modifier, TextFieldSelectionManager textFieldSelectionManager) {
        return !Magnifier_androidKt.isPlatformMagnifierSupported$default(0, 1, null) ? modifier : ComposedModifierKt.composed$default(modifier, null, new C03521(textFieldSelectionManager), 1, null);
    }
    ...
    static final class C03521 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        final /* synthetic */ TextFieldSelectionManager $manager;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03521(TextFieldSelectionManager textFieldSelectionManager) {
            super(3);
        ...
        public final Modifier invoke(Modifier modifier, Composer composer, int i) {
            ...
            if (objRememberedValue == Composer.INSTANCE.getEmpty()) {
                objRememberedValue = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(IntSize.m4899boximpl(IntSize.INSTANCE.m4912getZeroYbymL2g()), null, 2, null);
            ...
            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m2024boximpl(m1727invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1727invokeF1C5BW0() {
                        return TextFieldSelectionManagerKt.m1726calculateSelectionMagnifierCenterAndroidO0kMr_c(textFieldSelectionManager, TextFieldSelectionManager_androidKt.C03521.invoke$lambda$1(mutableState));
                    }
                };
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m2024boximpl(m1728invoketuRUvjQ(density2));
                            }
                        ...
                        return Magnifier_androidKt.m627magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt$textFieldMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void m1729invokeEaSLcWc(long j) {
                                ...
                                TextFieldSelectionManager_androidKt.C03521.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo688roundToPx0680j_4(DpSize.m4835getWidthD9Ej5fM(j)), density3.mo688roundToPx0680j_4(DpSize.m4833getHeightD9Ej5fM(j))));
                            }
        ...
        public static final void invoke$lambda$2(MutableState<IntSize> mutableState, long j) {
            mutableState.setValue(IntSize.m4899boximpl(j));
        }
    }
    ...
    public static final Function1<ContextMenuScope, Unit> contextMenuBuilder(final TextFieldSelectionManager textFieldSelectionManager, final ContextMenuState contextMenuState) {
        return new Function1<ContextMenuScope, Unit>() { // from class: androidx.compose.foundation.text.selection.TextFieldSelectionManager_androidKt.contextMenuBuilder.1
            ...
            public final void invoke2(ContextMenuScope contextMenuScope) {
                ...
                boolean zM4216getCollapsedimpl = TextRange.m4216getCollapsedimpl(textFieldSelectionManager.getValue$foundation_release().getSelection());
                final ContextMenuState contextMenuState2 = contextMenuState;
                TextContextMenuItems textContextMenuItems = TextContextMenuItems.Cut;
                boolean z2 = (zM4216getCollapsedimpl || !textFieldSelectionManager.getEditable() || z) ? false : true;
                ...
                boolean z3 = (zM4216getCollapsedimpl || z) ? false : true;
                ...
                boolean z5 = TextRange.m4218getLengthimpl(textFieldSelectionManager.getValue$foundation_release().getSelection()) != textFieldSelectionManager.getValue$foundation_release().getText().length();
