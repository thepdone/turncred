...
public final class SelectionAdjustmentKt {
    ...
    public static final Selection.AnchorInfo updateSelectionBoundary(final SelectionLayout selectionLayout, final SelectableInfo selectableInfo, Selection.AnchorInfo anchorInfo) {
        ...
        long jM4196getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m4196getWordBoundaryjx7JFs(offset);
        if (!isExpanding(selectableInfo, rawStartHandleOffset, selectionLayout.getIsStartHandle())) {
            return selectableInfo.anchorForOffset(rawStartHandleOffset);
        }
        if (offset == TextRange.m4222getStartimpl(jM4196getWordBoundaryjx7JFs) || offset == TextRange.m4217getEndimpl(jM4196getWordBoundaryjx7JFs)) {
            return updateSelectionBoundary$lambda$1(lazy2);
        }
        return selectableInfo.anchorForOffset(rawStartHandleOffset);
    }
    ...
    public static final Selection.AnchorInfo snapToWordBoundary(SelectableInfo selectableInfo, int i, int i2, int i3, boolean z, boolean z2) {
        int lineStart;
        int lineEnd$default;
        long jM4196getWordBoundaryjx7JFs = selectableInfo.getTextLayoutResult().m4196getWordBoundaryjx7JFs(i2);
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m4222getStartimpl(jM4196getWordBoundaryjx7JFs)) == i) {
            lineStart = TextRange.m4222getStartimpl(jM4196getWordBoundaryjx7JFs);
        ...
        if (selectableInfo.getTextLayoutResult().getLineForOffset(TextRange.m4217getEndimpl(jM4196getWordBoundaryjx7JFs)) == i) {
            lineEnd$default = TextRange.m4217getEndimpl(jM4196getWordBoundaryjx7JFs);
        } else if (i >= selectableInfo.getTextLayoutResult().getLineCount()) {
    ...
    private static final Selection.AnchorInfo anchorOnBoundary(SelectableInfo selectableInfo, boolean z, boolean z2, int i, BoundaryFunction boundaryFunction) {
        ...
        return selectableInfo.anchorForOffset(z ^ z2 ? TextRange.m4222getStartimpl(jMo1648getBoundaryfzxv0v0) : TextRange.m4217getEndimpl(jMo1648getBoundaryfzxv0v0));
    }
