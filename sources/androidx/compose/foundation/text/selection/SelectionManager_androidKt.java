...
public final class SelectionManager_androidKt {
    ...
    public static final Modifier selectionMagnifier(Modifier modifier, SelectionManager selectionManager) {
        return !Magnifier_androidKt.isPlatformMagnifierSupported$default(0, 1, null) ? modifier : ComposedModifierKt.composed$default(modifier, null, new C03511(selectionManager), 1, null);
    }
    ...
    static final class C03511 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
        final /* synthetic */ SelectionManager $manager;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C03511(SelectionManager selectionManager) {
            super(3);
            ...
            if (zChangedInstance || objRememberedValue2 == Composer.INSTANCE.getEmpty()) {
                objRememberedValue2 = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$1$1
                    ...
                    public /* bridge */ /* synthetic */ Offset invoke() {
                        return Offset.m2024boximpl(m1704invokeF1C5BW0());
                    }

                    /* renamed from: invoke-F1C5BW0, reason: not valid java name */
                    public final long m1704invokeF1C5BW0() {
                        return SelectionManagerKt.m1700calculateSelectionMagnifierCenterAndroidO0kMr_c(selectionManager, SelectionManager_androidKt.C03511.invoke$lambda$1(mutableState));
                    }
                };
                    ...
                    public final Modifier invoke2(final Function0<Offset> function02) {
                        ...
                        Function1<Density, Offset> function1 = new Function1<Density, Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.1
                            ...
                            public /* bridge */ /* synthetic */ Offset invoke(Density density2) {
                                return Offset.m2024boximpl(m1705invoketuRUvjQ(density2));
                            }
                        ...
                        return Magnifier_androidKt.m627magnifierjPUL71Q$default(companion, function1, null, new Function1<DpSize, Unit>() { // from class: androidx.compose.foundation.text.selection.SelectionManager_androidKt$selectionMagnifier$1$2$1.2
                            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                            {
                                super(1);
                            }
                            ...
                            public final void m1706invokeEaSLcWc(long j) {
                                ...
                                SelectionManager_androidKt.C03511.invoke$lambda$2(mutableState3, IntSizeKt.IntSize(density3.mo688roundToPx0680j_4(DpSize.m4835getWidthD9Ej5fM(j)), density3.mo688roundToPx0680j_4(DpSize.m4833getHeightD9Ej5fM(j))));
                            }
