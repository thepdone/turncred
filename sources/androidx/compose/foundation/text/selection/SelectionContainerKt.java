...
public final class SelectionContainerKt {
    public static final void SelectionContainer(final Modifier modifier, final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i, final int i2) {
        ...
        if ((i3 & 19) != 18 || !composerStartRestartGroup.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerEnd(composerStartRestartGroup);
            SelectionContainer(modifier, selectionSelectionContainer$lambda$1, (Function1) objRememberedValue2, function2, composerStartRestartGroup, (i3 & 14) | BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT | ((i3 << 6) & 7168), 0);
            if (ComposerKt.isTraceInProgress()) {
    ...
    public static final void DisableSelection(final Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, final int i) {
        ...
        if ((i2 & 3) != 2 || !composerStartRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider(SelectionRegistrarKt.getLocalSelectionRegistrar().provides(null), function2, composerStartRestartGroup, ((i2 << 3) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
            }
        } else {
                                                                ...
                                                                if (zBooleanValue) {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$1
                                                                        ...
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m2024boximpl(m1657invokeF1C5BW0());
                                                                        }
                                                                        ...
                                                                        public final long m1657invokeF1C5BW0() {
                                                                            ...
                                                                            return offsetM1693getStartHandlePosition_m7T9E != null ? offsetM1693getStartHandlePosition_m7T9E.getPackedValue() : Offset.INSTANCE.m2050getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                } else {
                                                                    obj = (Function0) new Function0<Offset>() { // from class: androidx.compose.foundation.text.selection.SelectionContainerKt$SelectionContainer$3$1$1$1$1$positionProvider$1$2
                                                                        ...
                                                                        @Override // kotlin.jvm.functions.Function0
                                                                        public /* bridge */ /* synthetic */ Offset invoke() {
                                                                            return Offset.m2024boximpl(m1658invokeF1C5BW0());
                                                                        }
                                                                        ...
                                                                        public final long m1658invokeF1C5BW0() {
                                                                            ...
                                                                            return offsetM1692getEndHandlePosition_m7T9E != null ? offsetM1692getEndHandlePosition_m7T9E.getPackedValue() : Offset.INSTANCE.m2050getUnspecifiedF1C5BW0();
                                                                        }
                                                                    };
                                                                }
