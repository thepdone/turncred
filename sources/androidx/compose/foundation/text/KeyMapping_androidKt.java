...
public final class KeyMapping_androidKt {
    private static final KeyMapping platformDefaultKeyMapping = new KeyMapping() { // from class: androidx.compose.foundation.text.KeyMapping_androidKt$platformDefaultKeyMapping$1
        ...
        public KeyCommand mo1318mapZmokQxo(KeyEvent event) {
            KeyCommand keyCommand = null;
            if (KeyEvent_androidKt.m3348isShiftPressedZmokQxo(event) && KeyEvent_androidKt.m3345isAltPressedZmokQxo(event)) {
            ...
            return keyCommand == null ? KeyMappingKt.getDefaultKeyMapping().mo1318mapZmokQxo(event) : keyCommand;
        }
    };
