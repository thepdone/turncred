...
public final class TextFieldStateKt {
    ...
    public static final TextFieldState m1433rememberTextFieldStateLepunE(final String str, final long j, Composer composer, int i, int i2) {
        ...
        boolean z = ((((i & 14) ^ 6) > 4 && composer.changed(str)) || (i & 6) == 4) | ((((i & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) ^ 48) > 32 && composer.changed(j)) || (i & 48) == 32);
        ...
        TextFieldState textFieldState = (TextFieldState) RememberSaveableKt.m1862rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 48, 4);
        if (ComposerKt.isTraceInProgress()) {
