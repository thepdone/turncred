        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null && (coreNodeCoordinates = this.textLayoutState.getCoreNodeCoordinates()) != null) {
                ...
                if (coreNodeCoordinates != null && (decoratorNodeCoordinates = this.textLayoutState.getDecoratorNodeCoordinates()) != null) {
                    ...
                    textLayoutNodeCoordinates.mo3629transformToScreen58bKbWc(this.matrix);
                    AndroidMatrixConversions_androidKt.m2146setFromEL8BTi8(this.androidMatrix, this.matrix);
                    return CursorAnchorInfoBuilder_androidKt.m1460buildvxqZcH0(this.builder, visualText, visualText.getSelection(), visualText.getComposition(), layoutResult, this.androidMatrix, SelectionManagerKt.visibleBounds(coreNodeCoordinates).m2072translatek4lQ0M(textLayoutNodeCoordinates.mo3622localPositionOfR5De75A(coreNodeCoordinates, Offset.INSTANCE.m2051getZeroF1C5BW0())), SelectionManagerKt.visibleBounds(decoratorNodeCoordinates).m2072translatek4lQ0M(textLayoutNodeCoordinates.mo3622localPositionOfR5De75A(decoratorNodeCoordinates, Offset.INSTANCE.m2051getZeroF1C5BW0())), this.includeInsertionMarker, this.includeCharacterBounds, this.includeEditorBounds, this.includeLineBounds);
                }
            }
        }
        return null;
