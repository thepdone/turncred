...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue state, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            int iM4220getMinimpl = composition != null ? TextRange.m4220getMinimpl(composition.getPackedValue()) : -1;
            TextRange composition2 = state.getComposition();
            inputMethodManager.updateSelection(TextRange.m4220getMinimpl(state.getSelection()), TextRange.m4219getMaximpl(state.getSelection()), iM4220getMinimpl, composition2 != null ? TextRange.m4219getMaximpl(composition2.getPackedValue()) : -1);
        }
    }
    ...
    public CharSequence getSelectedText(int flags) {
        if (TextRange.m4216getCollapsedimpl(this.textFieldValue.getSelection())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int reqModes) {
        return TextUtils.getCapsMode(this.textFieldValue.getText(), TextRange.m4220getMinimpl(this.textFieldValue.getSelection()), reqModes);
    }
    ...
    public boolean performEditorAction(int editorAction) {
        int iM4400getDefaulteUduSuo;
        boolean z = this.isActive;
        if (!z) {
            return z;
        }
        if (editorAction == 0) {
            iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4400getDefaulteUduSuo();
        } else {
            switch (editorAction) {
                case 2:
                    iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4402getGoeUduSuo();
                    break;
                case 3:
                    iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4406getSearcheUduSuo();
                    break;
                case 4:
                    iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4407getSendeUduSuo();
                    break;
                case 5:
                    iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4403getNexteUduSuo();
                    break;
                case 6:
                    iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4401getDoneeUduSuo();
                    break;
                case 7:
                    iM4400getDefaulteUduSuo = ImeAction.INSTANCE.m4405getPreviouseUduSuo();
                    break;
                default:
        ...
        this.eventCallback.mo1494onImeActionKlQnJC8(iM4400getDefaulteUduSuo);
        return true;
    }
