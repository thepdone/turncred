...
public abstract class TextFieldKeyEventHandler {
    ...
    public boolean mo1455onPreKeyEventMyFupTE(KeyEvent event, TransformedTextFieldState textFieldState, TextFieldSelectionState textFieldSelectionState, FocusManager focusManager, SoftwareKeyboardController keyboardController) {
        if (TextRange.m4216getCollapsedimpl(textFieldState.getVisualText().getSelection()) || !KeyEventHelpers_androidKt.m1317cancelsTextSelectionZmokQxo(event)) {
            return false;
        }
    ...
    public boolean mo1454onKeyEvent6ptp14s(KeyEvent event, TransformedTextFieldState textFieldState, TextLayoutState textLayoutState, TextFieldSelectionState textFieldSelectionState, boolean editable, boolean singleLine, Function0<Unit> onSubmit) {
        ...
        boolean z = false;
        if (!KeyEventType.m3335equalsimpl0(KeyEvent_androidKt.m3343getTypeZmokQxo(event), KeyEventType.INSTANCE.m3339getKeyDownCS__XNY())) {
            return false;
        }
        if (TextFieldKeyInput_androidKt.m1400isTypedEventZmokQxo(event) && (numM1316consumeZmokQxo = this.deadKeyCombiner.m1316consumeZmokQxo(event)) != null) {
            String string = StringHelpers_jvmKt.appendCodePointX(new StringBuilder(2), numM1316consumeZmokQxo.intValue()).toString();
            if (!editable) {
                return false;
            }
            boolean z2 = !TextFieldKeyEventHandler_androidKt.m1526isFromSoftKeyboardZmokQxo(event);
        ...
        KeyCommand keyCommandMo1318mapZmokQxo = this.keyMapping.mo1318mapZmokQxo(event);
        if (keyCommandMo1318mapZmokQxo != null && (!keyCommandMo1318mapZmokQxo.getEditsText() || editable)) {
            TextFieldPreparedSelection textFieldPreparedSelection = new TextFieldPreparedSelection(textFieldState, textLayoutState.getLayoutResult(), TextFieldKeyEventHandler_androidKt.m1526isFromSoftKeyboardZmokQxo(event), getVisibleTextLayoutHeight(textLayoutState), this.preparedSelectionState);
            switch (WhenMappings.$EnumSwitchMapping$0[keyCommandMo1318mapZmokQxo.ordinal()]) {
                ...
                case 19:
                    ...
                    break;
                case 20:
                    if (TextRange.m4216getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        Integer numValueOf = Integer.valueOf(textFieldPreparedSelection.getPrecedingCharacterIndex());
                        if (numValueOf.intValue() == -1) {
                            numValueOf = null;
                        }
                        textRangeM4210boximpl = numValueOf != null ? TextRange.m4210boximpl(TextRangeKt.TextRange(numValueOf.intValue(), TextRange.m4217getEndimpl(textFieldPreparedSelection.getSelection()))) : null;
                        if (textRangeM4210boximpl != null) {
                            TransformedTextFieldState.m1547replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM4210boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 21:
                    if (TextRange.m4216getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        textRangeM4210boximpl = numValueOf2 != null ? TextRange.m4210boximpl(TextRangeKt.TextRange(TextRange.m4222getStartimpl(textFieldPreparedSelection.getSelection()), numValueOf2.intValue())) : null;
                        if (textRangeM4210boximpl != null) {
                            TransformedTextFieldState.m1547replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", textRangeM4210boximpl.getPackedValue(), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                        }
                    } else {
                ...
                case 22:
                    if (!TextRange.m4216getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1547replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getPreviousWordOffset(), TextRange.m4217getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 23:
                    if (!TextRange.m4216getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1547replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m4222getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getNextWordOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 24:
                    if (!TextRange.m4216getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1547replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(textFieldPreparedSelection.getLineStartByOffset(), TextRange.m4217getEndimpl(textFieldPreparedSelection.getSelection())), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 25:
                    if (!TextRange.m4216getCollapsedimpl(textFieldPreparedSelection.getSelection())) {
                        ...
                        TransformedTextFieldState.m1547replaceTextM8tDOmk$default(textFieldPreparedSelection.state, "", TextRangeKt.TextRange(TextRange.m4222getStartimpl(textFieldPreparedSelection.getSelection()), textFieldPreparedSelection.getLineEndByOffset()), null, !textFieldPreparedSelection.isFromSoftKeyboard, 4, null);
                    }
                    z = true;
                    break;
                case 26:
            ...
            if (!TextRange.m4215equalsimpl0(textFieldPreparedSelection.getSelection(), textFieldPreparedSelection.getInitialValue().getSelection())) {
                textFieldState.m1554selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
            }
        }
        return z;
    }
    ...
    private final void preparedSelectionContext(TransformedTextFieldState state, TextLayoutState textLayoutState, boolean isFromSoftKeyboard, Function1<? super TextFieldPreparedSelection, Unit> block) {
        ...
        state.m1554selectCharsIn5zctL8(textFieldPreparedSelection.getSelection());
    }
        ...
        if (textLayoutNodeCoordinates != null) {
            ...
            if (textLayoutNodeCoordinates != null) {
                ...
                if (rectLocalBoundingBoxOf$default != null) {
                    return Size.m2101getHeightimpl(rectLocalBoundingBoxOf$default.m2068getSizeNHjbRc());
                }
            }
        }
        return Float.NaN;
