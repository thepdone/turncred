...
public final class StatelessInputConnection_androidKt {
    ...
    public static final ExtractedText toExtractedText(TextFieldCharSequence textFieldCharSequence) {
        ...
        extractedText.selectionStart = TextRange.m4220getMinimpl(textFieldCharSequence.getSelection());
        extractedText.selectionEnd = TextRange.m4219getMaximpl(textFieldCharSequence.getSelection());
