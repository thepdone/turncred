...
public final class TextFieldPreparedSelection {
    ...
    public final void deleteIfSelectedOr(Function0<TextRange> block) {
        if (!TextRange.m4216getCollapsedimpl(getSelection())) {
    ...
    private final int jumpByPagesOffset(int pagesAmount) {
        int iM4217getEndimpl = TextRange.m4217getEndimpl(this.initialValue.getSelection());
        if (this.textLayoutResult == null || Float.isNaN(this.visibleTextLayoutHeight)) {
            return iM4217getEndimpl;
        }
        Rect rectTranslate = this.textLayoutResult.getCursorRect(iM4217getEndimpl).translate(0.0f, this.visibleTextLayoutHeight * pagesAmount);
        ...
        if (Math.abs(rectTranslate.getTop() - lineBottom) > Math.abs(rectTranslate.getBottom() - lineBottom)) {
            return this.textLayoutResult.m4194getOffsetForPositionk4lQ0M(rectTranslate.m2070getTopLeftF1C5BW0());
        }
        return this.textLayoutResult.m4194getOffsetForPositionk4lQ0M(rectTranslate.m2063getBottomLeftF1C5BW0());
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.text, TextRange.m4217getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.text, TextRange.m4217getEndimpl(this.selection));
    }
    ...
    private final boolean isLtr() {
        ...
        TextLayoutResult textLayoutResult = this.textLayoutResult;
        return textLayoutResult == null || (paragraphDirection = textLayoutResult.getParagraphDirection(TextRange.m4217getEndimpl(this.selection))) == null || paragraphDirection == ResolvedTextDirection.Ltr;
    }
    ...
    static /* synthetic */ int getNextWordOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m4217getEndimpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.initialValue.length()) {
            long jM4196getWordBoundaryjx7JFs = textLayoutResult.m4196getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4217getEndimpl(jM4196getWordBoundaryjx7JFs) > i) {
                return TextRange.m4217getEndimpl(jM4196getWordBoundaryjx7JFs);
            }
            i++;
        }
    ...
    private final int getPrevWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            long jM4196getWordBoundaryjx7JFs = textLayoutResult.m4196getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m4222getStartimpl(jM4196getWordBoundaryjx7JFs) < i) {
                return TextRange.m4222getStartimpl(jM4196getWordBoundaryjx7JFs);
            }
            i--;
        }
        return 0;
    ...
    static /* synthetic */ int getLineStartByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m4220getMinimpl(textFieldPreparedSelection.selection);
        }
    ...
    static /* synthetic */ int getLineEndByOffsetForLayout$default(TextFieldPreparedSelection textFieldPreparedSelection, TextLayoutResult textLayoutResult, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            i = TextRange.m4219getMaximpl(textFieldPreparedSelection.selection);
        }
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        int iM4217getEndimpl = TextRange.m4217getEndimpl(this.selection);
        if (Float.isNaN(this.textPreparedSelectionState.getCachedX())) {
            this.textPreparedSelectionState.setCachedX(textLayoutResult.getCursorRect(iM4217getEndimpl).getLeft());
        }
        int lineForOffset = textLayoutResult.getLineForOffset(iM4217getEndimpl) + i;
        if (lineForOffset < 0) {
            return 0;
        }
        ...
        return textLayoutResult.m4194getOffsetForPositionk4lQ0M(OffsetKt.Offset(cachedX, lineBottom));
    }
    ...
    public final TextFieldPreparedSelection deselect() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            setCursor(TextRange.m4217getEndimpl(this.selection));
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection collapseLeftOr(Function1<? super TextFieldPreparedSelection, Unit> or) {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            if (TextRange.m4216getCollapsedimpl(this.selection)) {
                or.invoke(this);
            } else if (isLtr()) {
                setCursor(TextRange.m4220getMinimpl(this.selection));
            } else {
                setCursor(TextRange.m4219getMaximpl(this.selection));
            }
        }
        return this;
    }
    ...
    private final TextFieldPreparedSelection moveCursorPrev() {
        ...
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (iCalculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (iM4217getEndimpl = TextRange.m4217getEndimpl(this.selection)), false, this.state)) != iM4217getEndimpl) {
    ...
    private final TextFieldPreparedSelection moveCursorNext() {
        ...
        int iCalculateAdjacentCursorPosition;
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0 && (iCalculateAdjacentCursorPosition = TextPreparedSelectionKt.calculateAdjacentCursorPosition(this.text, (iM4217getEndimpl = TextRange.m4217getEndimpl(this.selection)), true, this.state)) != iM4217getEndimpl) {
            setCursor(iCalculateAdjacentCursorPosition);
        }
        return this;
    }
    ...
    public final TextFieldPreparedSelection moveCursorPrevByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int iFindParagraphStart = StringHelpersKt.findParagraphStart(this.text, TextRange.m4220getMinimpl(this.selection));
            if (iFindParagraphStart == TextRange.m4220getMinimpl(this.selection) && iFindParagraphStart != 0) {
    ...
    public final TextFieldPreparedSelection moveCursorNextByParagraph() {
        this.textPreparedSelectionState.resetCachedX();
        if (this.text.length() > 0) {
            int iFindParagraphEnd = StringHelpersKt.findParagraphEnd(this.text, TextRange.m4219getMaximpl(this.selection));
            if (iFindParagraphEnd == TextRange.m4219getMaximpl(this.selection) && iFindParagraphEnd != this.text.length()) {
    ...
    public final TextFieldPreparedSelection selectMovement() {
        if (this.text.length() > 0) {
            this.selection = TextRangeKt.TextRange(TextRange.m4222getStartimpl(this.initialValue.getSelection()), TextRange.m4217getEndimpl(this.selection));
        }
        return this;
    }
}
