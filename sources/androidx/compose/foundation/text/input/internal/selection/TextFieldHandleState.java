...
public final /* data */ class TextFieldHandleState {
    ...
    private static final TextFieldHandleState Hidden = new TextFieldHandleState(false, Offset.INSTANCE.m2050getUnspecifiedF1C5BW0(), ResolvedTextDirection.Ltr, false, null);
    ...
    public final TextFieldHandleState m1564copyubNVwUQ(boolean visible, long position, ResolvedTextDirection direction, boolean handlesCrossed) {
    ...
    public boolean equals(Object other) {
        ...
        return this.visible == textFieldHandleState.visible && Offset.m2032equalsimpl0(this.position, textFieldHandleState.position) && this.direction == textFieldHandleState.direction && this.handlesCrossed == textFieldHandleState.handlesCrossed;
    }

    public int hashCode() {
        return (((((Boolean.hashCode(this.visible) * 31) + Offset.m2037hashCodeimpl(this.position)) * 31) + this.direction.hashCode()) * 31) + Boolean.hashCode(this.handlesCrossed);
    }

    public String toString() {
        return "TextFieldHandleState(visible=" + this.visible + ", position=" + ((Object) Offset.m2043toStringimpl(this.position)) + ", direction=" + this.direction + ", handlesCrossed=" + this.handlesCrossed + ')';
    }
