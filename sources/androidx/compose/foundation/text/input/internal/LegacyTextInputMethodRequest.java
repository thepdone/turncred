...
public final class LegacyTextInputMethodRequest implements PlatformTextInputMethodRequest {
    ...
    private TextFieldValue state = new TextFieldValue("", TextRange.INSTANCE.m4227getZerod9O1mEE(), (TextRange) null, 4, (DefaultConstructorMarker) null);
    ...
    public RecordingInputConnection createInputConnection(EditorInfo outAttributes) {
        EditorInfo_androidKt.m1467updatepLxbY9I$default(outAttributes, this.state.getText(), this.state.getSelection(), this.imeOptions, null, 8, null);
        ...
        RecordingInputConnection recordingInputConnection = new RecordingInputConnection(textFieldValue, new InputEventCallback2() { // from class: androidx.compose.foundation.text.input.internal.LegacyTextInputMethodRequest.createInputConnection.1
            ...
            public void mo1494onImeActionKlQnJC8(int imeAction) {
                LegacyTextInputMethodRequest.this.onImeActionPerformed.invoke(ImeAction.m4384boximpl(imeAction));
            }
    ...
    public final void updateState(TextFieldValue oldValue, TextFieldValue newValue) {
        boolean z = (TextRange.m4215equalsimpl0(this.state.getSelection(), newValue.getSelection()) && Intrinsics.areEqual(this.state.getComposition(), newValue.getComposition())) ? false : true;
        this.state = newValue;
        ...
        if (Intrinsics.areEqual(oldValue, newValue)) {
            if (z) {
                ...
                int iM4220getMinimpl = TextRange.m4220getMinimpl(newValue.getSelection());
                int iM4219getMaximpl = TextRange.m4219getMaximpl(newValue.getSelection());
                ...
                inputMethodManager.updateSelection(iM4220getMinimpl, iM4219getMaximpl, iM4220getMinimpl2, composition2 != null ? TextRange.m4219getMaximpl(composition2.getPackedValue()) : -1);
                return;
            }
            return;
        }
        if (oldValue != null && (!Intrinsics.areEqual(oldValue.getText(), newValue.getText()) || (TextRange.m4215equalsimpl0(oldValue.getSelection(), newValue.getSelection()) && !Intrinsics.areEqual(oldValue.getComposition(), newValue.getComposition())))) {
