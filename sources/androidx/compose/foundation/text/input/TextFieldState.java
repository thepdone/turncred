...
public final class TextFieldState {
    ...
    private TextFieldState(String str, long j, TextUndoManager textUndoManager) {
        ...
        this.mainBuffer = new EditingBuffer(str, TextRangeKt.m4228coerceIn8ffj60Q(j, 0, str.length()), (DefaultConstructorMarker) null);
    ...
    public String toString() {
        ...
        try {
            return "TextFieldState(selection=" + ((Object) TextRange.m4225toStringimpl(m1431getSelectiond9O1mEE())) + ", text=\"" + ((Object) getText()) + "\")";
        } finally {
    ...
    public final void commitEdit(TextFieldBuffer newValue) {
        ...
        boolean zM4215equalsimpl0 = true ^ TextRange.m4215equalsimpl0(newValue.getSelectionInChars(), this.mainBuffer.m1463getSelectiond9O1mEE());
        if (z) {
            this.textUndoManager.clearHistory();
        }
        m1432syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(newValue, null, z, zM4215equalsimpl0);
    }
    ...
    public final void commitEditAsUser(InputTransformation inputTransformation, boolean restartImeIfContentChanges, TextFieldEditUndoBehavior undoBehavior) {
        ...
        if (this.mainBuffer.getChangeTracker().getChangeCount() == 0 && TextRange.m4215equalsimpl0(value$foundation_release.getSelection(), this.mainBuffer.m1463getSelectiond9O1mEE())) {
            ...
            updateValueAndNotifyListeners(getValue$foundation_release(), new TextFieldCharSequence(this.mainBuffer.toString(), this.mainBuffer.m1463getSelectiond9O1mEE(), this.mainBuffer.m1462getCompositionMzsxiRA(), this.mainBuffer.getHighlight(), null), restartImeIfContentChanges);
            return;
        }
        ...
        boolean zM4215equalsimpl0 = TextRange.m4215equalsimpl0(textFieldBuffer2.getSelectionInChars(), textFieldCharSequence.getSelection());
        boolean z2 = !zM4215equalsimpl0;
        if (!zContentEquals || !zM4215equalsimpl0) {
            textFieldBuffer = textFieldBuffer2;
            m1432syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(textFieldBuffer, null, z, z2);
        } else {
            textFieldBuffer = textFieldBuffer2;
            updateValueAndNotifyListeners(value$foundation_release, TextFieldBuffer.m1421toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer2, 0L, textFieldCharSequence.getComposition(), 1, null), restartImeIfContentChanges);
        }
    ...
    public final void m1432syncMainBufferToTemporaryBufferTS3Rm5k$foundation_release(TextFieldBuffer textFieldBuffer, TextRange newComposition, boolean textChanged, boolean selectionChanged) {
        ...
        boolean zAreEqual = Intrinsics.areEqual(newComposition, this.mainBuffer.m1462getCompositionMzsxiRA());
        if (textChanged) {
            ...
            this.mainBuffer.setSelection(TextRange.m4222getStartimpl(textFieldBuffer.getSelectionInChars()), TextRange.m4217getEndimpl(textFieldBuffer.getSelectionInChars()));
        }
        if (newComposition == null || TextRange.m4216getCollapsedimpl(newComposition.getPackedValue())) {
            this.mainBuffer.commitComposition();
        } else {
            this.mainBuffer.setComposition(TextRange.m4220getMinimpl(newComposition.getPackedValue()), TextRange.m4219getMaximpl(newComposition.getPackedValue()));
        }
    ...
    public static final class Saver implements androidx.compose.runtime.saveable.Saver<TextFieldState, Object> {
        ...
        public Object save(SaverScope saverScope, TextFieldState textFieldState) {
            return CollectionsKt.listOf(textFieldState.getText().toString(), Integer.valueOf(TextRange.m4222getStartimpl(textFieldState.m1431getSelectiond9O1mEE())), Integer.valueOf(TextRange.m4217getEndimpl(textFieldState.m1431getSelectiond9O1mEE())), TextUndoManager.Companion.Saver.INSTANCE.save(saverScope, textFieldState.getTextUndoManager()));
        }
