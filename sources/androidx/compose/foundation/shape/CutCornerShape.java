...
public final class CutCornerShape extends CornerBasedShape {
    ...
    public Outline mo1268createOutlineLjSzlW0(long size, float topStart, float topEnd, float bottomEnd, float bottomStart, LayoutDirection layoutDirection) {
        ...
        Path.lineTo(Size.m2104getWidthimpl(size) - topStart, 0.0f);
        Path.lineTo(Size.m2104getWidthimpl(size), topStart);
        float f2 = layoutDirection == LayoutDirection.Ltr ? bottomEnd : bottomStart;
        Path.lineTo(Size.m2104getWidthimpl(size), Size.m2101getHeightimpl(size) - f2);
        Path.lineTo(Size.m2104getWidthimpl(size) - f2, Size.m2101getHeightimpl(size));
        if (layoutDirection == LayoutDirection.Ltr) {
            bottomEnd = bottomStart;
        }
        Path.lineTo(bottomEnd, Size.m2101getHeightimpl(size));
        Path.lineTo(0.0f, Size.m2101getHeightimpl(size) - bottomEnd);
        Path.close();
