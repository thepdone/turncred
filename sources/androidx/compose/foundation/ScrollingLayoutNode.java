...
public final class ScrollingLayoutNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo412measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        ...
        final Placeable placeableMo3613measureBRTryo0 = measurable.mo3613measureBRTryo0(Constraints.m4681copyZbe2FdA$default(j, 0, this.isVertical ? Constraints.m4690getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, this.isVertical ? Integer.MAX_VALUE : Constraints.m4689getMaxHeightimpl(j), 5, null));
        int iCoerceAtMost = RangesKt.coerceAtMost(placeableMo3613measureBRTryo0.getWidth(), Constraints.m4690getMaxWidthimpl(j));
        int iCoerceAtMost2 = RangesKt.coerceAtMost(placeableMo3613measureBRTryo0.getHeight(), Constraints.m4689getMaxHeightimpl(j));
        final int height = placeableMo3613measureBRTryo0.getHeight() - iCoerceAtMost2;
        int width = placeableMo3613measureBRTryo0.getWidth() - iCoerceAtMost;
        if (!this.isVertical) {
            height = width;
        }
