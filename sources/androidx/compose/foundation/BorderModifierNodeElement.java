...
public final /* data */ class BorderModifierNodeElement extends ModifierNodeElement<BorderModifierNode> {
    ...
    public final BorderModifierNodeElement m579copy8Feqmps(float width, Brush brush, Shape shape) {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4742equalsimpl0(this.width, borderModifierNodeElement.width) && Intrinsics.areEqual(this.brush, borderModifierNodeElement.brush) && Intrinsics.areEqual(this.shape, borderModifierNodeElement.shape);
    }

    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((Dp.m4743hashCodeimpl(this.width) * 31) + this.brush.hashCode()) * 31) + this.shape.hashCode();
    }

    public String toString() {
        return "BorderModifierNodeElement(width=" + ((Object) Dp.m4748toStringimpl(this.width)) + ", brush=" + this.brush + ", shape=" + this.shape + ')';
    }
    ...
    public void update(BorderModifierNode node) {
        node.m576setWidth0680j_4(this.width);
    ...
    public void inspectableProperties(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("width", Dp.m4735boximpl(this.width));
        if (this.brush instanceof SolidColor) {
            inspectorInfo.getProperties().set(ViewProps.COLOR, Color.m2266boximpl(((SolidColor) this.brush).getValue()));
            inspectorInfo.setValue(Color.m2266boximpl(((SolidColor) this.brush).getValue()));
        } else {
