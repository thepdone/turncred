...
public abstract class LazyListMeasuredItemProvider implements LazyLayoutMeasuredItemProvider<LazyListMeasuredItem> {
    ...
    public abstract LazyListMeasuredItem mo1105createItemX9ElhV4(int index, Object key, Object contentType, List<? extends Placeable> placeables, long constraints);
    ...
    private LazyListMeasuredItemProvider(long j, boolean z, LazyListItemProvider lazyListItemProvider, LazyLayoutMeasureScope lazyLayoutMeasureScope) {
        ...
        this.childConstraints = ConstraintsKt.Constraints$default(0, z ? Constraints.m4690getMaxWidthimpl(j) : Integer.MAX_VALUE, 0, z ? Integer.MAX_VALUE : Constraints.m4689getMaxHeightimpl(j), 5, null);
    }
    ...
    public LazyListMeasuredItem mo1116getAndMeasurehBUhpc(int index, int lane, int span, long constraints) {
        return m1117getAndMeasure0kLqBqw(index, constraints);
    }
    ...
    public final LazyListMeasuredItem m1117getAndMeasure0kLqBqw(int index, long constraints) {
        return mo1105createItemX9ElhV4(index, this.itemProvider.getKey(index), this.itemProvider.getContentType(index), this.measureScope.mo1173measure0kLqBqw(index, constraints), constraints);
    }
