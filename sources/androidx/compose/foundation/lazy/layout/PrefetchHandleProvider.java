...
public final class PrefetchHandleProvider {
    ...
    public final LazyLayoutPrefetchState.PrefetchHandle m1187schedulePrefetchVKLhPVY(int index, long constraints, PrefetchMetrics prefetchMetrics) {
    ...
    private final class HandleAndRequestImpl implements LazyLayoutPrefetchState.PrefetchHandle, PrefetchRequest {
        ...
        public boolean execute(PrefetchRequestScope prefetchRequestScope) {
            ...
            if (!this.isMeasured && !Constraints.m4694isZeroimpl(this.constraints)) {
        ...
        private final void m1188performMeasureBRTryo0(long constraints) {
            if (this.isCanceled) {
            ...
            for (int i = 0; i < placeablesCount; i++) {
                precomposedSlotHandle.mo3639premeasure0kLqBqw(i, constraints);
            }
        }
        ...
        public String toString() {
            return "HandleAndRequestImpl { index = " + this.index + ", constraints = " + ((Object) Constraints.m4695toStringimpl(this.constraints)) + ", isComposed = " + isComposed() + ", isMeasured = " + this.isMeasured + ", isCanceled = " + this.isCanceled + " }";
        }
