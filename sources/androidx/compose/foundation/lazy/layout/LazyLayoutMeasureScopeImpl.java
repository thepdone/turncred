...
public final class LazyLayoutMeasureScopeImpl implements LazyLayoutMeasureScope, MeasureScope {
    ...
    public List<Placeable> mo1173measure0kLqBqw(int index, long constraints) {
        ...
        for (int i = 0; i < size; i++) {
            arrayList.add(listSubcompose.get(i).mo3613measureBRTryo0(constraints));
        }
