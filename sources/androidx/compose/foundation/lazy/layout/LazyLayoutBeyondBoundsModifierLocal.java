...
public final class LazyLayoutBeyondBoundsModifierLocal implements ModifierLocalProvider<BeyondBoundsLayout>, BeyondBoundsLayout {
    ...
    public <T> T mo1155layouto7g1Pn8(final int direction, Function1<? super BeyondBoundsLayout.BeyondBoundsScope, ? extends T> block) {
        int firstPlacedIndex;
        if (this.state.getItemCount() <= 0 || !this.state.getHasVisibleItems()) {
            return block.invoke(emptyBeyondBoundsScope);
        }
        if (m1153isForward4vf7U8o(direction)) {
        ...
        T tInvoke = null;
        while (tInvoke == null && m1152hasMoreContentFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction)) {
            T t = (T) m1151addNextIntervalFR3nfPY((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element, direction);
            ...
            tInvoke = block.invoke(new BeyondBoundsLayout.BeyondBoundsScope() { // from class: androidx.compose.foundation.lazy.layout.LazyLayoutBeyondBoundsModifierLocal$layout$2
                @Override // androidx.compose.ui.layout.BeyondBoundsLayout.BeyondBoundsScope
                public boolean getHasMoreContent() {
                    return this.this$0.m1152hasMoreContentFR3nfPY(objectRef.element, direction);
                }
            });
        }
        this.beyondBoundsInfo.removeInterval((LazyLayoutBeyondBoundsInfo.Interval) objectRef.element);
    ...
    private final boolean m1153isForward4vf7U8o(int i) {
        if (BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3599getBeforehoxUOeE())) {
            return false;
        }
        if (!BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3598getAfterhoxUOeE())) {
            if (BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3597getAbovehoxUOeE())) {
                return this.reverseLayout;
            }
            if (BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3600getBelowhoxUOeE())) {
                if (this.reverseLayout) {
                    return false;
                }
            } else if (BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3601getLefthoxUOeE())) {
                ...
                if (!BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3602getRighthoxUOeE())) {
    ...
    private final LazyLayoutBeyondBoundsInfo.Interval m1151addNextIntervalFR3nfPY(LazyLayoutBeyondBoundsInfo.Interval currentInterval, int direction) {
    ...
    private final boolean m1154isOppositeToOrientation4vf7U8o(int i) {
        if (!(BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3597getAbovehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3600getBelowhoxUOeE()))) {
            if (!(BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3601getLefthoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3602getRighthoxUOeE()))) {
                if (!(BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3599getBeforehoxUOeE()) ? true : BeyondBoundsLayout.LayoutDirection.m3593equalsimpl0(i, BeyondBoundsLayout.LayoutDirection.INSTANCE.m3598getAfterhoxUOeE()))) {
                    LazyLayoutBeyondBoundsModifierLocalKt.unsupportedDirection();
                    throw new KotlinNothingValueException();
                }
