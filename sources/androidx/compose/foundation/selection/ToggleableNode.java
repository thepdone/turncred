...
final class ToggleableNode extends ClickableNode {
    ...
    public final void m1266updateQzZPfjk(boolean value, MutableInteractionSource interactionSource, IndicationNodeFactory indicationNodeFactory, boolean enabled, Role role, Function1<? super Boolean, Unit> onValueChange) {
        if (this.value != value) {
            this.value = value;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        this.onValueChange = onValueChange;
        super.m598updateQzZPfjk(interactionSource, indicationNodeFactory, enabled, (String) null, role, this._onClick);
    }
