...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public void update(SelectableNode node) {
        node.m1257updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public int hashCode() {
        ...
        Role role = this.role;
        return ((iHashCode3 + (role != null ? Role.m4029hashCodeimpl(role.getValue()) : 0)) * 31) + this.onClick.hashCode();
    }
}
