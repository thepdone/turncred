...
public final class PagerStateKt {
    ...
    private static final float DefaultPositionThreshold = Dp.m4737constructorimpl(56);
    ...
    public static final PagerState rememberPagerState(final int i, final float f, final Function0<Integer> function0, Composer composer, int i2, int i3) {
        ...
        boolean z = ((((i2 & 14) ^ 6) > 4 && composer.changed(i)) || (i2 & 6) == 4) | ((((i2 & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) ^ 48) > 32 && composer.changed(f)) || (i2 & 48) == 32) | ((((i2 & 896) ^ BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) > 256 && composer.changed(function0)) || (i2 & BitmapCounterConfig.DEFAULT_MAX_BITMAP_COUNT) == 256);
        ...
        DefaultPagerState defaultPagerState = (DefaultPagerState) RememberSaveableKt.m1862rememberSaveable(objArr, (Saver) saver, (String) null, (Function0) objRememberedValue, composer, 0, 4);
    ...
    public static final long calculateNewMaxScrollOffset(PagerLayoutInfo pagerLayoutInfo, int i) {
        ...
        int iM4907getWidthimpl = pagerLayoutInfo.getOrientation() == Orientation.Horizontal ? IntSize.m4907getWidthimpl(pagerLayoutInfo.mo1241getViewportSizeYbymL2g()) : IntSize.m4906getHeightimpl(pagerLayoutInfo.mo1241getViewportSizeYbymL2g());
        return RangesKt.coerceAtLeast(pageSpacing - (iM4907getWidthimpl - RangesKt.coerceIn(pagerLayoutInfo.getSnapPosition().position(iM4907getWidthimpl, pagerLayoutInfo.getPageSize(), pagerLayoutInfo.getBeforeContentPadding(), pagerLayoutInfo.getAfterContentPadding(), i - 1, i), 0, iM4907getWidthimpl)), 0L);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long calculateNewMinScrollOffset(PagerMeasureResult pagerMeasureResult, int i) {
        int iM4907getWidthimpl = pagerMeasureResult.getOrientation() == Orientation.Horizontal ? IntSize.m4907getWidthimpl(pagerMeasureResult.mo1241getViewportSizeYbymL2g()) : IntSize.m4906getHeightimpl(pagerMeasureResult.mo1241getViewportSizeYbymL2g());
        return RangesKt.coerceIn(pagerMeasureResult.getSnapPosition().position(iM4907getWidthimpl, pagerMeasureResult.getPageSize(), pagerMeasureResult.getBeforeContentPadding(), pagerMeasureResult.getAfterContentPadding(), 0, i), 0, iM4907getWidthimpl);
    }
