...
public final class OverscrollConfiguration {
    ...
    public boolean equals(Object other) {
        ...
        return Color.m2277equalsimpl0(this.glowColor, overscrollConfiguration.glowColor) && Intrinsics.areEqual(this.drawPadding, overscrollConfiguration.drawPadding);
    }

    public int hashCode() {
        return (Color.m2283hashCodeimpl(this.glowColor) * 31) + this.drawPadding.hashCode();
    }

    public String toString() {
        return "OverscrollConfiguration(glowColor=" + ((Object) Color.m2284toStringimpl(this.glowColor)) + ", drawPadding=" + this.drawPadding + ')';
    }
}
