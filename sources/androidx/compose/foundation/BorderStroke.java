...
public final class BorderStroke {
    ...
    public boolean equals(Object other) {
        ...
        return Dp.m4742equalsimpl0(this.width, borderStroke.width) && Intrinsics.areEqual(this.brush, borderStroke.brush);
    }

    public int hashCode() {
        return (Dp.m4743hashCodeimpl(this.width) * 31) + this.brush.hashCode();
    }

    public String toString() {
        return "BorderStroke(width=" + ((Object) Dp.m4748toStringimpl(this.width)) + ", brush=" + this.brush + ')';
    }
    ...
    public final BorderStroke m582copyD5KLDUw(float width, Brush brush) {
