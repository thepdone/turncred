...
final /* data */ class FlowMeasureLazyPolicy implements FlowLineMeasurePolicy {
    ...
    public final MeasureResult m943measure0kLqBqw(final SubcomposeMeasureScope subcomposeMeasureScope, long j) {
        ...
        if (this.itemCount <= 0 || this.maxLines == 0 || this.maxItemsInMainAxis == 0 || (Constraints.m4689getMaxHeightimpl(j) == 0 && this.overflow.getType$foundation_layout_release() != FlowLayoutOverflow.OverflowType.Visible)) {
