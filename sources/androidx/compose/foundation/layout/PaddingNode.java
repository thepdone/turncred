...
final class PaddingNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo412measure3p2s80s(final MeasureScope measureScope, Measurable measurable, long j) {
        ...
        return MeasureScope.layout$default(measureScope, ConstraintsKt.m4707constrainWidthK40F9xA(j, placeableMo3613measureBRTryo0.getWidth() + i), ConstraintsKt.m4706constrainHeightK40F9xA(j, placeableMo3613measureBRTryo0.getHeight() + i2), null, new Function1<Placeable.PlacementScope, Unit>() { // from class: androidx.compose.foundation.layout.PaddingNode$measure$1
            ...
            public final void invoke2(Placeable.PlacementScope placementScope) {
                if (this.this$0.getRtlAware()) {
                    Placeable.PlacementScope.placeRelative$default(placementScope, placeableMo3613measureBRTryo0, measureScope.mo688roundToPx0680j_4(this.this$0.getStart()), measureScope.mo688roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                } else {
                    Placeable.PlacementScope.place$default(placementScope, placeableMo3613measureBRTryo0, measureScope.mo688roundToPx0680j_4(this.this$0.getStart()), measureScope.mo688roundToPx0680j_4(this.this$0.getTop()), 0.0f, 4, null);
                }
            }
        }, 4, null);
    }
    ...
    public /* synthetic */ PaddingNode(float f, float f2, float f3, float f4, boolean z, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m4737constructorimpl(0) : f, (i & 2) != 0 ? Dp.m4737constructorimpl(0) : f2, (i & 4) != 0 ? Dp.m4737constructorimpl(0) : f3, (i & 8) != 0 ? Dp.m4737constructorimpl(0) : f4, z, null);
    }
}
