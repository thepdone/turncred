...
final class AlignmentLineOffsetTextUnitElement extends ModifierNodeElement<AlignmentLineOffsetTextUnitNode> {
    ...
    @Override // androidx.compose.ui.node.ModifierNodeElement
    public int hashCode() {
        return (((this.alignmentLine.hashCode() * 31) + TextUnit.m4931hashCodeimpl(this.before)) * 31) + TextUnit.m4931hashCodeimpl(this.after);
    }
    ...
    public boolean equals(Object other) {
        ...
        return Intrinsics.areEqual(this.alignmentLine, alignmentLineOffsetTextUnitElement.alignmentLine) && TextUnit.m4927equalsimpl0(this.before, alignmentLineOffsetTextUnitElement.before) && TextUnit.m4927equalsimpl0(this.after, alignmentLineOffsetTextUnitElement.after);
    }
    ...
    public void update(AlignmentLineOffsetTextUnitNode node) {
        ...
        node.m871setBeforeR2X_6o(this.before);
        node.m870setAfterR2X_6o(this.after);
    }
}
