...
final class LimitInsets implements WindowInsets {
    ...
    public String toString() {
        return "(" + this.insets + " only " + ((Object) WindowInsetsSides.m1086toStringimpl(this.sides)) + ')';
    }
}
