...
public final class RowKt {
    ...
    public static final void Row(Modifier modifier, Arrangement.Horizontal horizontal, Alignment.Vertical vertical, Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3, Composer composer, int i, int i2) {
        ...
        Updater.m1776setimpl(composerM1769constructorimpl, measurePolicyRowMeasurePolicy, ComposeUiNode.INSTANCE.getSetMeasurePolicy());
        ...
        function3.invoke(RowScopeInstance.INSTANCE, composer, Integer.valueOf(((i >> 6) & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | 6));
    ...
    public static final long createRowConstraints(boolean z, int i, int i2, int i3, int i4) {
        ...
        return Constraints.INSTANCE.m4699fitPrioritizingWidthZbe2FdA(i, i3, i2, i4);
    }
}
