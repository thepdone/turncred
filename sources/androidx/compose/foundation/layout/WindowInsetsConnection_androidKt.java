...
public final class WindowInsetsConnection_androidKt {
    ...
    public static final NestedScrollConnection m1070rememberWindowInsetsConnectionVRgvIgI(AndroidWindowInsets androidWindowInsets, int i, Composer composer, int i2) {
        ...
        SideCalculator sideCalculatorM1030chooseCalculatorni1skBw = SideCalculator.INSTANCE.m1030chooseCalculatorni1skBw(i, (LayoutDirection) objConsume);
        ...
        boolean zChanged = ((((i2 & 14) ^ 6) > 4 && composer.changed(androidWindowInsets)) || (i2 & 6) == 4) | composer.changed(view) | composer.changed(sideCalculatorM1030chooseCalculatorni1skBw) | composer.changed(density);
