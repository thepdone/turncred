...
final class AlignmentLineOffsetTextUnitNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public MeasureResult mo412measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        return AlignmentLineKt.m851alignmentLineOffsetMeasuretjqqzMA(measureScope, this.alignmentLine, !TextUnitKt.m4948isUnspecifiedR2X_6o(this.before) ? measureScope.mo689toDpGaN1DYA(this.before) : Dp.INSTANCE.m4757getUnspecifiedD9Ej5fM(), !TextUnitKt.m4948isUnspecifiedR2X_6o(this.after) ? measureScope.mo689toDpGaN1DYA(this.after) : Dp.INSTANCE.m4757getUnspecifiedD9Ej5fM(), measurable, j);
    }
}
