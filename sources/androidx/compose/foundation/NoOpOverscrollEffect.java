...
public final class NoOpOverscrollEffect implements OverscrollEffect {
    ...
    public long mo539applyToScrollRhakbz0(long delta, int source, Function1<? super Offset, Offset> performScroll) {
        return performScroll.invoke(Offset.m2024boximpl(delta)).getPackedValue();
    }

    @Override // androidx.compose.foundation.OverscrollEffect
    /* renamed from: applyToFling-BMRW4eQ */
    public Object mo538applyToFlingBMRW4eQ(long j, Function2<? super Velocity, ? super Continuation<? super Velocity>, ? extends Object> function2, Continuation<? super Unit> continuation) {
        Object objInvoke = function2.invoke(Velocity.m4965boximpl(j), continuation);
