...
final class DefaultDebugIndication implements IndicationNodeFactory {
    ...
    static final class DefaultDebugIndicationInstance extends Modifier.Node implements DrawModifierNode {
        ...
        public void draw(ContentDrawScope contentDrawScope) {
            ...
            if (this.isPressed) {
                DrawScope.m2827drawRectnJ9OG0$default(contentDrawScope, Color.m2275copywmQWz5c$default(Color.INSTANCE.m2302getBlack0d7_KjU(), 0.3f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2833getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            } else if (this.isHovered || this.isFocused) {
                DrawScope.m2827drawRectnJ9OG0$default(contentDrawScope, Color.m2275copywmQWz5c$default(Color.INSTANCE.m2302getBlack0d7_KjU(), 0.1f, 0.0f, 0.0f, 0.0f, 14, null), 0L, contentDrawScope.mo2833getSizeNHjbRc(), 0.0f, null, null, 0, 122, null);
            }
        }
    }
}
