...
public final class DraggableKt {
    ...
    public static final float m767toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m2036getYimpl(j) : Offset.m2035getXimpl(j);
    }
    ...
    public static final float m768toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m4975getYimpl(j) : Velocity.m4974getXimpl(j);
    }
    ...
    public static final long m769toValidVelocityTH1AsA0(long j) {
        return VelocityKt.Velocity(Float.isNaN(Velocity.m4974getXimpl(j)) ? 0.0f : Velocity.m4974getXimpl(j), Float.isNaN(Velocity.m4975getYimpl(j)) ? 0.0f : Velocity.m4975getYimpl(j));
    }
}
