        ...
        if (i == 0) {
            ...
            ScrollScope scrollScope = new ScrollScope() { // from class: androidx.compose.foundation.gestures.ScrollingLogic$doFlingAnimation$2$reverseScope$1
                ...
                public float scrollBy(float pixels) {
                    ...
                    return scrollingLogic4.reverseIfNeeded(scrollingLogic4.m819toFloatk4lQ0M(nestedScrollScope.mo776scrollByWithOverscrollOzD1aCk(scrollingLogic4.m817reverseIfNeededMKHz9U(scrollingLogic4.m820toOffsettuRUvjQ(pixels)), NestedScrollSource.INSTANCE.m3378getSideEffectWNlRxjI())));
                }
            };
