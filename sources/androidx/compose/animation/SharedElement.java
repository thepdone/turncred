...
public final class SharedElement {
    ...
    public final Rect getTargetBounds() {
        ...
        set_targetBounds(sharedElementInternalState != null ? RectKt.m2075Recttz77jQw(sharedElementInternalState.m427calculateLookaheadOffsetF1C5BW0(), sharedElementInternalState.m428getNonNullLookaheadSizeNHjbRc()) : null);
    ...
    public final void m426onLookaheadResultv_w8tDc(SharedElementInternalState state, long lookaheadSize, long topLeft) {
        if (state.getBoundsAnimation().getTarget()) {
            this.targetBoundsProvider = state;
            Rect rect = get_targetBounds();
            Offset offsetM2024boximpl = rect != null ? Offset.m2024boximpl(rect.m2070getTopLeftF1C5BW0()) : null;
            if (offsetM2024boximpl == null ? false : Offset.m2032equalsimpl0(offsetM2024boximpl.getPackedValue(), topLeft)) {
                Rect rect2 = get_targetBounds();
                Size sizeM2092boximpl = rect2 != null ? Size.m2092boximpl(rect2.m2068getSizeNHjbRc()) : null;
                if (sizeM2092boximpl == null ? false : Size.m2100equalsimpl0(sizeM2092boximpl.getPackedValue(), lookaheadSize)) {
                    return;
                }
            }
            Rect rectM2075Recttz77jQw = RectKt.m2075Recttz77jQw(topLeft, lookaheadSize);
            set_targetBounds(rectM2075Recttz77jQw);
            SnapshotStateList<SharedElementInternalState> snapshotStateList = this.states;
            int size = snapshotStateList.size();
            for (int i = 0; i < size; i++) {
                ...
                boundsAnimation.animate(currentBounds, rectM2075Recttz77jQw);
            }
        }
    }
