...
public final class SharedTransitionScopeImpl implements SharedTransitionScope, LookaheadScope {
    ...
    public long mo430localLookaheadPositionOfauaQtc(LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2, long j, boolean z) {
    ...
    */
    ...
    private static final class ShapeBasedClip implements SharedTransitionScope.OverlayClip {
        ...
        public Path getClipPath(SharedTransitionScope.SharedContentState state, Rect bounds, LayoutDirection layoutDirection, Density density) {
            this.path.reset();
            OutlineKt.addOutline(this.path, this.clipShape.mo605createOutlinePq9zytI(bounds.m2068getSizeNHjbRc(), layoutDirection, density));
            this.path.mo2171translatek4lQ0M(bounds.m2070getTopLeftF1C5BW0());
            return this.path;
        }
    }
}
