...
public final /* data */ class Scale {
    ...
    public final Scale m422copybnNdC4k(float scale, long transformOrigin, FiniteAnimationSpec<Float> animationSpec) {
    ...
    public boolean equals(Object other) {
        ...
        return Float.compare(this.scale, scale.scale) == 0 && TransformOrigin.m2662equalsimpl0(this.transformOrigin, scale.transformOrigin) && Intrinsics.areEqual(this.animationSpec, scale.animationSpec);
    }

    public int hashCode() {
        return (((Float.hashCode(this.scale) * 31) + TransformOrigin.m2665hashCodeimpl(this.transformOrigin)) * 31) + this.animationSpec.hashCode();
    }

    public String toString() {
        return "Scale(scale=" + this.scale + ", transformOrigin=" + ((Object) TransformOrigin.m2666toStringimpl(this.transformOrigin)) + ", animationSpec=" + this.animationSpec + ')';
    }
