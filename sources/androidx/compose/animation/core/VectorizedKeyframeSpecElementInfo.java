...
public final /* data */ class VectorizedKeyframeSpecElementInfo<V extends AnimationVector> {
    ...
    public final VectorizedKeyframeSpecElementInfo<V> m526copy2NF0KzA(V vectorValue, Easing easing, int arcMode) {
    ...
    public String toString() {
        return "VectorizedKeyframeSpecElementInfo(vectorValue=" + this.vectorValue + ", easing=" + this.easing + ", arcMode=" + ((Object) ArcMode.m469toStringimpl(this.arcMode)) + ')';
    }
