...
final class ToContinuation<T> implements Runnable {
    ...
    public void run() {
        ...
        try {
            ...
            cancellableContinuation.resumeWith(Result.m5937constructorimpl(AbstractResolvableFuture.getUninterruptibly(this.futureToObserve)));
            ...
            cancellableContinuation2.resumeWith(Result.m5937constructorimpl(ResultKt.createFailure(thNonNullCause)));
        }
    }
}
