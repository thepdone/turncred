...
public class FileProvider extends ContentProvider {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        private boolean belongsToRoot(String str, String str2) {
            ...
            return strRemoveTrailingSlash.equals(strRemoveTrailingSlash2) || strRemoveTrailingSlash.startsWith(new StringBuilder().append(strRemoveTrailingSlash2).append(IOUtils.DIR_SEPARATOR_UNIX).toString());
        }
    }
