...
public class TransitionManager {
    ...
    private static void changeScene(Scene scene, Transition transition) {
        ...
        Transition transitionMo5057clone = transition.mo5057clone();
        transitionMo5057clone.setSceneRoot(sceneRoot);
        if (currentScene != null && currentScene.isCreatedFromLayoutResource()) {
            transitionMo5057clone.setCanRemoveViews(true);
        }
        sceneChangeSetup(sceneRoot, transitionMo5057clone);
        scene.enter();
        sceneChangeRunTransition(sceneRoot, transitionMo5057clone);
    }
    ...
    public static void beginDelayedTransition(ViewGroup viewGroup, Transition transition) {
        ...
        Transition transitionMo5057clone = transition.mo5057clone();
        sceneChangeSetup(viewGroup, transitionMo5057clone);
        Scene.setCurrentScene(viewGroup, null);
        sceneChangeRunTransition(viewGroup, transitionMo5057clone);
    }
