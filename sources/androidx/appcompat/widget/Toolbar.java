...
public class Toolbar extends ViewGroup implements MenuHost {
    ...
    private void ensureMenuView() {
        if (this.mMenuView == null) {
            ...
            layoutParamsGenerateDefaultLayoutParams.gravity = (this.mButtonGravity & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | GravityCompat.END;
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            ...
            LayoutParams layoutParamsGenerateDefaultLayoutParams = generateDefaultLayoutParams();
            layoutParamsGenerateDefaultLayoutParams.gravity = (this.mButtonGravity & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | GravityCompat.START;
    ...
    */
    ...
    private int getChildVerticalGravity(int i) {
        ...
        return (i2 == 16 || i2 == 48 || i2 == 80) ? i2 : this.mGravity & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS;
    }
    ...
    private class ExpandedActionViewMenuPresenter implements MenuPresenter {
        ...
        public boolean expandItemActionView(MenuBuilder menuBuilder, MenuItemImpl menuItemImpl) {
            ...
            if (parent2 != toolbar3) {
                ...
                layoutParamsGenerateDefaultLayoutParams.gravity = (Toolbar.this.mButtonGravity & OctetSequenceKeyGenerator.MIN_KEY_SIZE_BITS) | GravityCompat.START;
                layoutParamsGenerateDefaultLayoutParams.mViewType = 2;
