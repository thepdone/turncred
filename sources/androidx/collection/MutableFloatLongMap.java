    ...
    private final void dropDeletes() {
        ...
        while (i4 != i3) {
            ...
            if (j == 128) {
                ...
                if (j == 254) {
                    int iHashCode = Float.hashCode(fArr2[i4]) * ScatterMapKt.MurmurHashC1;
