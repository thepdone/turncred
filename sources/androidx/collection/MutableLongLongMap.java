                ...
                if (j == 254) {
                    ...
                    if (((iFindFirstAvailableSlot - i8) & i3) / 8 == ((i4 - i8) & i3) / 8) {
                        ...
                        if (((j2 >> i10) & 255) == 128) {
                            ...
                            jArr[i11] = 0;
                            jArr4[iFindFirstAvailableSlot] = jArr4[i11];
                            jArr4[i11] = 0;
                            i2 = i11;
                            iFindEmptySlot = i2;
                            i = i3;
                            ...
                            jArr4[iFindFirstAvailableSlot] = jArr4[i13];
                            jArr4[i13] = jArr4[iFindEmptySlot];
                            i2 = i13 - 1;
                        }
                        c = 0;
